...
SHOW WARNINGS;
CREATE UNIQUE INDEX `id_UNIQUE` ON `target` (`id` ASC);
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `target_progress` ;
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `id_UNIQUE` ON `target_progress` (`id` ASC);
