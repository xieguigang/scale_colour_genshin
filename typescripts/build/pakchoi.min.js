...
$ts.mode=Modes.debug;$ts(webapp.start);(function(a){a.hookImagePreviews=function(a,d){var b=$image(d),c;$input(a).onchange=function(d){c=$input(a).files[0];b.src=URL.createObjectURL(c)}};a.displayMsg=function(a){}})(webapp||(webapp={}));
