...
3E3):console.error(d.info)})};a.prototype.doCheckLogin=function(){$ts.get("@api:check",function(d){0==d.code?"1"==d.info&&successMsg("???????",function(){$goto("/home")}):errorMsg(d.info,function(){location.reload()})})};return a}(Bootstrap);c.login=e})(pages||(pages={}));
...
(function(c){var e=function(b){function a(){var d=null!==b&&b.apply(this,arguments)||this;d.loadVisitsDone=!1;d.loadLoginsDone=!1;return d}__extends(a,b);Object.defineProperty(a.prototype,"appName",{get:function(){return"profile"},enumerable:!0,configurable:!0});a.prototype.init=function(){var d=this,a=loading("\u6b63\u5728\u52a0\u8f7d\u6570\u636e...");$ts.get("@api:visits",function(b){0==b.code?(d.renderVisitList(b.info),d.loadVisitsDone,d.loadVisitsDone&&d.loadLoginsDone&&layer.close(a)):(layer.closeAll(),
errorMsg(b.info))});$ts.get("@api:logins",function(b){0==b.code?(d.renderLoginList(b.info),d.loadLoginsDone,d.loadVisitsDone&&d.loadLoginsDone&&layer.close(a)):(layer.closeAll(),errorMsg(b.info))})};a.prototype.renderLoginList=function(a){for(var d=$ts("#login-list"),b,c=0;c<a.length;c++)b=a[c],b=$ts("<span>",{style:"font-size:0.8em;color:lightgray"}).display(b.create_time).append($ts("<span>",{}).display(b.content)),d.append($ts("<li>").display(b))};a.prototype.renderVisitList=function(a){for(var d=
