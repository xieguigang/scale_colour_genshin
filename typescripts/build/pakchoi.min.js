...
(function(a){(function(a){function c(a,c){for(var b=0;b<c.length;b++){var d=c[b],e=$ts("<div>",{class:"col-md-4"});e.append($ts("<img>",{src:d.avatar,class:"img-fluid rounded-circle shadow-lg",style:"width: 24px;"})).append($ts("<span>",{style:"font-size:0.9em;"}).display(d.message));a.append($ts("<div>",{class:"row"}).display(e))}}a.fetchComments=function(a,d){void 0===d&&(d=null);$ts.get("@api:load?resource="+a,function(a){if(0==a.code){a=a.info;var b=$ts("#comment-list");c(b,a);!isNullOrUndefined(d)&&
0<a.length&&d(a[0].id)}})};a.appendComments=c})(a.modules||(a.modules={}))})(webapp||(webapp={}));(function(a){(function(a){function c(){"granted"==Notification.permission&&$ts.get("@api:getNewMsg",function(a){if(0==a.code){var b=a.info,c=new Notification(b.title,{body:b.content,icon:b.iconImage||"/favicon.png"});c.onclick=function(){c.close();Strings.Empty(b.link)||$goto(b.link)}}})}a.startNotification=function(){setInterval(c,1E3)}})(a.modules||(a.modules={}))})(webapp||(webapp={}));
