...
(function(a){var c=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"home"},enumerable:!0,configurable:!0});b.prototype.init=function(){$ts.select(".type0").ForEach(function(a){return a.style.display="none"});$ts("#share_geo").onclick=function(){webapp.models.getLocation()}};return b}(Bootstrap);a.home=c})(pages||(pages={}));
(function(a){var c=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"chat"},enumerable:!0,configurable:!0});b.prototype.init=function(){var a=this;setInterval(function(){a.fetchMessage()},1E3);$ts("#send").onclick=function(){a.sendComment()};$ts("#share_geo").onclick=function(){webapp.models.getLocation()}};b.prototype.sendComment=function(){var a=$ts.value("#comment"),b={resource:-1,comment:a};
if(Strings.Empty(a))return webapp.displayMsg("\u8bc4\u8bba\u4e0d\u53ef\u4ee5\u4e3a\u7a7a\uff01");$ts.post("@api:comment",b,function(a){0==a.code&&$ts.value("#comment","")})};b.prototype.fetchMessage=function(){var a=this;webapp.models.fetchComments("-1",this.lastId,function(b){a.lastId=b})};return b}(Bootstrap);a.chat=c})(pages||(pages={}));
...
break;case a.TIMEOUT:alert("\u5b9a\u4f4d\u5931\u8d25,\u8bf7\u6c42\u83b7\u53d6\u7528\u6237\u4f4d\u7f6e\u8d85\u65f6");break;default:alert("\u5b9a\u4f4d\u5931\u8d25,\u5b9a\u4f4d\u7cfb\u7edf\u5931\u6548")}}a.getLocation=function(){"http"==$ts.location.url.protocol.toLowerCase()?c():navigator.geolocation?navigator.geolocation.getCurrentPosition(b,e):alert("\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u5730\u7406\u5b9a\u4f4d\u3002")}})(a.models||(a.models={}))})(webapp||(webapp={}));
...
0<a.length&&c(a[0].id)}})}})(a.models||(a.models={}))})(webapp||(webapp={}));
