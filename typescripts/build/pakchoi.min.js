...
errorMsg(d.info))});$ts.get("@api:logins",function(d){0==d.code?(a.renderLoginList(d.info),a.loadLoginsDone=!0,a.loadVisitsDone&&a.loadLoginsDone&&layer.close(b)):(layer.closeAll(),errorMsg(d.info))})};a.prototype.renderLoginList=function(a){for(var d=$ts("#login-list"),b,c=0;c<a.length;c++)b=a[c],b=$ts("<span>",{style:"font-size:0.8em;color:lightgray"}).display(b.create_time).append($ts("<span>",{}).display(b.content)),d.append($ts("<li>").display(b))};a.prototype.renderVisitList=function(a){for(var d=
$ts("#visit-list"),b,c=0;c<a.length;c++)b=a[c],b=$ts("<span>",{style:"font-size:0.8em;color:lightgray"}).display(b.time).append($ts("<span>",{}).display($ts("<a>",{href:b.page_url}).display(b.page_url))),d.append($ts("<li>").display(b))};return a}(Bootstrap);c.profile=e})(pages||(pages={}));
...
(function(c){var e=function(b){function a(){return null!==b&&b.apply(this,arguments)||this}__extends(a,b);Object.defineProperty(a.prototype,"appName",{get:function(){return"share_video"},enumerable:!0,configurable:!0});a.prototype.init=function(){throw Error("Method not implemented.");};return a}(Bootstrap);c.share_video=e})(pages||(pages={}));
