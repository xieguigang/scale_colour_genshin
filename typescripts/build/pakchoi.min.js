...
function(a){return a.value}).Object;$ts.upload("@api:upload",a,function(a){0==a.code?(isNullOrUndefined(b)&&(b={}),b.note=$ts.value("#note"),b.res=a.info,$ts.post("@api:addnote",b,function(a){$goto("/gallery")})):console.error(a.info)})};return a}(Bootstrap);c.share_photo=e})(pages||(pages={}));
...
a.append($ts("<div>",{class:"row"}).display(e))}}c.fetchComments=function(a,c,e){void 0===e&&(e=null);$ts.get("@api:load?resource="+a+"&type="+c,function(a){if(0==a.code){a=a.info;var c=$ts("#comment-list");b(c,a);!isNullOrUndefined(e)&&0<a.length&&e(a[a.length-1].id)}})};c.appendComments=b})(c.modules||(c.modules={}))})(webapp||(webapp={}));
