...
(function(a){var c=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"home"},enumerable:!0,configurable:!0});b.prototype.init=function(){$ts.select(".type0").ForEach(function(a){return a.style.display="none"});$ts("#share_geo").onclick=function(){webapp.modules.getLocation()}};return b}(Bootstrap);a.home=c})(pages||(pages={}));
...
(function(a){a.start=function(){Router.AddAppHandler(new pages.index);Router.AddAppHandler(new pages.login);Router.AddAppHandler(new pages.share_photo);Router.AddAppHandler(new pages.view_photo);Router.AddAppHandler(new pages.edit_profile);Router.AddAppHandler(new pages.home);Router.AddAppHandler(new pages.chat);Notification.requestPermission().then(function(c){"granted"==c?a.modules.startNotification():a.displayMsg("\u6d88\u606f\u6743\u9650\u88ab\u62d2\u7edd")});Router.RunApp()}})(webapp||(webapp=
