...
(function(a){(function(a){function c(a,c){for(var b=0;b<c.length;b++){var d=c[b],e=$ts("<div>",{class:"col-md-4"});e.append($ts("<img>",{src:d.avatar,class:"img-fluid rounded-circle shadow-lg",style:"width: 24px;"}));var f=$ts("<span>",{style:"font-size:0.85em; color: lightgray"}).display(d.message_time+"&nbsp;");d=$ts("<span>",{style:"font-size:0.9em;"}).display(d.message);e.append(f).append(d);a.append($ts("<div>",{class:"row"}).display(e))}}a.fetchComments=function(a,d){void 0===d&&(d=null);$ts.get("@api:load?resource="+
