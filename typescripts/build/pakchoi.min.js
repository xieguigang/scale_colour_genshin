...
var __extends=this&&this.__extends||function(){var a=function(c,e){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(b,d){b.__proto__=d}||function(b,d){for(var a in d)d.hasOwnProperty(a)&&(b[a]=d[a])};return a(c,e)};return function(c,e){function b(){this.constructor=c}a(c,e);c.prototype=null===e?Object.create(e):(b.prototype=e.prototype,new b)}}(),pages;
...
(function(a){var c=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"login"},enumerable:!0,configurable:!0});b.prototype.init=function(){var d=this;$ts.select(".people-link").onClick(function(a){return d.doLogin(a.getAttribute("people"))})};b.prototype.doLogin=function(a){var d=this;clearInterval();$ts("#open-msg").click();$ts.post("@api:login",{people:a},function(a){0==a.code?setInterval(function(){d.doCheckLogin()},
...
a?webapp.modules.startNotification():webapp.displayMsg("\u6d88\u606f\u6743\u9650\u88ab\u62d2\u7edd")});console.log(Notification.permission);webapp.modules.startNotification()};$("#open-msg").click()};return b}(Bootstrap);a.home=c})(pages||(pages={}));
(function(a){var c=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"chat"},enumerable:!0,configurable:!0});b.prototype.init=function(){var a=this;setInterval(function(){a.fetchMessage()},1E3);$ts("#send").onclick=function(){a.sendComment()};$ts("#share_geo").onclick=function(){webapp.modules.getLocation()};webapp.modules.fetchComments("-1",function(b){a.lastId=b})};b.prototype.sendComment=function(){var a=
$ts.value("#comment"),b={resource:-1,comment:a};if(Strings.Empty(a))return webapp.displayMsg("\u8bc4\u8bba\u4e0d\u53ef\u4ee5\u4e3a\u7a7a\uff01");$ts.post("@api:comment",b,function(a){0==a.code&&$ts.value("#comment","")})};b.prototype.fetchMessage=function(){var a=this;$ts.get("@api:update?last_id="+a.lastId,function(b){if(0==b.code){b=b.info;var d=$ts("#comment-list");0<b.length&&(a.lastId=b[b.length-1].id);webapp.modules.appendComments(d,b)}})};return b}(Bootstrap);a.chat=c})(pages||(pages={}));
...
(function(a){var c=function(a){function b(){var b=null!==a&&a.apply(this,arguments)||this;b.activityId=$ts("@data:activityId");return b}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"view/location"},enumerable:!0,configurable:!0});b.prototype.init=function(){$ts.get("@api:getLocation?id="+this.activityId,function(a){console.log(a)})};return b}(Bootstrap);a.view_location=c})(pages||(pages={}));
...
break;case a.TIMEOUT:alert("\u5b9a\u4f4d\u5931\u8d25,\u8bf7\u6c42\u83b7\u53d6\u7528\u6237\u4f4d\u7f6e\u8d85\u65f6");break;default:alert("\u5b9a\u4f4d\u5931\u8d25,\u5b9a\u4f4d\u7cfb\u7edf\u5931\u6548")}}a.getLocation=function(){"http"==$ts.location.url.protocol.toLowerCase()?c():navigator.geolocation?navigator.geolocation.getCurrentPosition(b,d):alert("\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u5730\u7406\u5b9a\u4f4d\u3002")}})(a.modules||(a.modules={}))})(webapp||(webapp={}));
(function(a){(function(a){function c(a,c){for(var b=0;b<c.length;b++){var d=c[b],e=$ts("<div>",{class:"col-md-4"});e.append($ts("<img>",{src:d.avatar,class:"img-fluid rounded-circle shadow-lg",style:"width: 24px;"}));var f=$ts("<span>",{style:"font-size:0.7em; color: lightgray"}).display(d.message_time+"<br />");d=$ts("<span>",{style:"font-size:0.9em;"}).display(d.message);e.append(f).append(d);a.append($ts("<div>",{class:"row"}).display(e))}}a.fetchComments=function(a,d){void 0===d&&(d=null);$ts.get("@api:load?resource="+
a,function(a){if(0==a.code){a=a.info;var b=$ts("#comment-list");c(b,a);!isNullOrUndefined(d)&&0<a.length&&d(a[a.length-1].id)}})};a.appendComments=c})(a.modules||(a.modules={}))})(webapp||(webapp={}));
