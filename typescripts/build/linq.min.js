...
(c=c.ToArray());return(new Enumerable.JoinHelper(this.sequence,c)).Union(b,a,f,g)};d.prototype.Join=function(c,b,a,f,g){void 0===g&&(g=null);Array.isArray(c)||(c=c.ToArray());return(new Enumerable.JoinHelper(this.sequence,c)).LeftJoin(b,a,f,g)};d.prototype.Select=function(c){return Enumerable.Select(this.sequence,c)};d.prototype.GroupBy=function(c,b){if(isNullOrUndefined(b))switch(typeof c(this.First)){case "string":b=Strings.CompareTo;break;case "number":b=function(a,b){return a-b};break;case "boolean":b=
function(a,b){return a==b?0:1==a?1:-1};break;default:throw"No element comparer was specific!";}return Enumerable.GroupBy(this.sequence,c,b)};d.prototype.Where=function(c){return Enumerable.Where(this.sequence,c)};d.prototype.Which=function(c,b){void 0===b&&(b=!0);var a;b||(a=[]);for(var f=0;f<this.sequence.length;f++)if(c(this.sequence[f])){if(b)return f;a.push(f)}return new d(a)};d.prototype.Min=function(c){void 0===c&&(c=function(b){return Strings.as_numeric(b)});return Enumerable.OrderBy(this.sequence,
c).First};d.prototype.Max=function(c){void 0===c&&(c=function(b){return Strings.as_numeric(b)});return Enumerable.OrderByDescending(this.sequence,c).First};d.prototype.Average=function(c){void 0===c&&(c=null);return 0==this.Count?0:this.Sum(c)/this.sequence.length};d.prototype.Sum=function(c){void 0===c&&(c=null);var b=0;c||(c=function(a){return Number(a)});for(var a=0,f=this.sequence;a<f.length;a++)b+=c(f[a]);return b};d.prototype.OrderBy=function(c){return Enumerable.OrderBy(this.sequence,c)};d.prototype.OrderByDescending=
function(c){return Enumerable.OrderByDescending(this.sequence,c)};d.prototype.Split=function(c){for(var b=[],a=[],f=0,g=this.sequence;f<g.length;f++){var e=g[f];a.length<c?a.push(e):(b.push(a),a=[])}0<a.length&&b.push(a);return new d(b)};d.prototype.Take=function(c){return Enumerable.Take(this.sequence,c)};d.prototype.Skip=function(c){return Enumerable.Skip(this.sequence,c)};d.prototype.Reverse=function(){var c=this.ToArray().reverse();return new d(c)};d.prototype.TakeWhile=function(c){return Enumerable.TakeWhile(this.sequence,
c)};d.prototype.SkipWhile=function(c){return Enumerable.SkipWhile(this.sequence,c)};d.prototype.All=function(c){return Enumerable.All(this.sequence,c)};d.prototype.Any=function(c){void 0===c&&(c=null);return c?Enumerable.Any(this.sequence,c):this.sequence&&0!=this.sequence.length?!0:!1};d.prototype.Distinct=function(c){void 0===c&&(c=function(b){return b.toString()});return this.GroupBy(c,Strings.CompareTo).Select(function(b){return b.First})};d.prototype.ChunkWith=function(c,b){void 0===b&&(b=!1);
for(var a=new List,f=[],g=0,d=this.sequence;g<d.length;g++){var e=d[g];c(e)?(a.Add(f),f=b?[e]:[]):f.push(e)}0<f.length&&a.Add(f);return a};d.prototype.ForEach=function(c){this.sequence.forEach(c)};d.prototype.JoinBy=function(c,b){void 0===b&&(b=function(a){return"string"===typeof a?a:a.toString()});return this.Select(function(a){return b(a)}).ToArray().join(c)};d.prototype.Unlist=function(c){void 0===c&&(c=function(a){return a});for(var b=[],a=0,f=this.sequence;a<f.length;a++)for(var g=0,e=c(f[a]);g<
e.length;g++)b.push(e[g]);return new d(b)};d.prototype.ToArray=function(c){void 0===c&&(c=!0);return c?this.sequence.slice():this.sequence};d.prototype.ToList=function(){return new List(this.sequence)};d.prototype.ToDictionary=function(c,b){void 0===b&&(b=function(a){return a});for(var a={},f,g,d=0,e=this.sequence;d<e.length;d++)g=e[d],f=c(g),g=b(g),a[f]=g;return new Dictionary(a)};d.prototype.ToPointer=function(){return new Pointer(this)};d.prototype.SlideWindows=function(c,b){void 0===b&&(b=1);
return SlideWindow.Split(this,c,b)};return d}(LINQIterator),DOMEnumerator=function(e){function d(c){return e.call(this,d.ensureElements(c))||this}__extends(d,e);Object.defineProperty(d.prototype,"tagName",{get:function(){return this.First.tagName},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"type",{get:function(){return"input"==this.tagName.toLowerCase()?this.First.type:this.tagName},enumerable:!0,configurable:!0});d.ensureElements=function(c){var b=$ts.typeof(c);if("NodeList"==
b.class){var a=[];c.forEach(function(b){return a.push(b)})}else if("HTMLCollection"==b.class)for(a=[],b=0;b<c.length;b++)a.push(c.item(b));else a=Framework.Extensions.EnsureArray(c);c=0;for(b=a;c<b.length;c++)TypeExtensions.Extends(b[c]);return a};d.prototype.val=function(c){void 0===c&&(c=null);if(isNullOrUndefined(c))return this.Select(function(b){return d.getVal(b)});"string"==typeof c||"number"==typeof c?this.ForEach(function(b){return d.setVal(b,c)}):Array.isArray(c)?this.ForEach(function(b,
a){return d.setVal(b,c[a])}):this.ForEach(function(b,a){return d.setVal(b,c.ElementAt(a))})};d.setVal=function(c,b){c instanceof HTMLInputElement?c.value=b:c.textContent=b};d.getVal=function(c){return c instanceof HTMLInputElement?c.value:c.textContent};d.prototype.attr=function(c,b){void 0===b&&(b=null);if(b){if("function"==typeof b)return this.Select(function(a){var f=b(a);a.setAttribute(c,f);return f});var a=Framework.Extensions.EnsureArray(b,this.Count);return this.Select(function(b,g){g=a[g];
b.setAttribute(c,g);return g})}return this.Select(function(a){return a.getAttribute(c)})};d.prototype.addClass=function(c){this.ForEach(function(b){b.classList.contains(c)||b.classList.add(c)});return this};d.prototype.addEvent=function(c,b){this.ForEach(function(a){DOM.Events.addEvent(a,c,function(f){b(a,f)})})};d.prototype.onChange=function(c){this.addEvent("onchange",c)};d.prototype.onClick=function(c){this.ForEach(function(b){b.onclick=function(a){c(this,a);return!1}})};d.prototype.removeClass=
