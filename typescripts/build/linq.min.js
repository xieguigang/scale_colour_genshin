...
!0:!1};e.prototype.Distinct=function(c){void 0===c&&(c=function(b){return b.toString()});return this.GroupBy(c,Strings.CompareTo).Select(function(b){return b.First})};e.prototype.ChunkWith=function(c,b){void 0===b&&(b=!1);for(var a=new List,f=[],g=0,e=this.sequence;g<e.length;g++){var d=e[g];c(d)?(a.Add(f),f=b?[d]:[]):f.push(d)}0<f.length&&a.Add(f);return a};e.prototype.ForEach=function(c){this.sequence.forEach(function(b,a,f){c(b,a)})};e.prototype.JoinBy=function(c,b){void 0===b&&(b=function(a){return"string"===
typeof a?a:a.toString()});return this.Select(function(a){return b(a)}).ToArray().join(c)};e.prototype.Unlist=function(c){void 0===c&&(c=function(a){return a});for(var b=[],a=0,f=this.sequence;a<f.length;a++)for(var g=0,d=c(f[a]);g<d.length;g++)b.push(d[g]);return new e(b)};e.prototype.ToArray=function(c){void 0===c&&(c=!0);return c?this.sequence.slice():this.sequence};e.prototype.ToList=function(){return new List(this.sequence)};e.prototype.ToDictionary=function(c,b){void 0===b&&(b=function(a){return a});
for(var a={},f,g,e=0,d=this.sequence;e<d.length;e++)g=d[e],f=c(g),g=b(g),a[f]=g;return new Dictionary(a)};e.prototype.ToPointer=function(){return new Pointer(this)};e.prototype.SlideWindows=function(c,b){void 0===b&&(b=1);return SlideWindow.Split(this,c,b)};return e}(LINQIterator),DOMEnumerator=function(d){function e(c){return d.call(this,e.ensureElements(c))||this}__extends(e,d);Object.defineProperty(e.prototype,"tagName",{get:function(){return this.First.tagName},enumerable:!0,configurable:!0});
Object.defineProperty(e.prototype,"type",{get:function(){return"input"==this.tagName.toLowerCase()?this.First.type:this.tagName},enumerable:!0,configurable:!0});e.ensureElements=function(c){var b=$ts.typeof(c);if("NodeList"==b.class){var a=[];c.forEach(function(b){return a.push(b)})}else if("HTMLCollection"==b.class)for(a=[],b=0;b<c.length;b++)a.push(c.item(b));else a=Framework.Extensions.EnsureArray(c);c=0;for(b=a;c<b.length;c++)TypeExtensions.Extends(b[c]);return a};e.prototype.val=function(c){void 0===
c&&(c=null);if(isNullOrUndefined(c))return this.Select(function(b){return e.getVal(b)});"string"==typeof c||"number"==typeof c?this.ForEach(function(b){return e.setVal(b,c)}):Array.isArray(c)?this.ForEach(function(b,a){return e.setVal(b,c[a])}):this.ForEach(function(b,a){return e.setVal(b,c.ElementAt(a))})};e.setVal=function(c,b){c instanceof HTMLInputElement?c.value=b:c.textContent=b};e.getVal=function(c){return c instanceof HTMLInputElement?c.value:c.textContent};e.prototype.attr=function(c,b){void 0===
b&&(b=null);if(b){if("function"==typeof b)return this.Select(function(a){var f=b(a);a.setAttribute(c,f);return f});var a=Framework.Extensions.EnsureArray(b,this.Count);return this.Select(function(b,g){g=a[g];b.setAttribute(c,g);return g})}return this.Select(function(a){return a.getAttribute(c)})};e.prototype.style=function(c){var b=DOM.CSS.parseStylesheet(c);this.ForEach(function(a){return DOM.CSS.Setter.setStyle(a,b)});return this};e.prototype.addClass=function(c){this.ForEach(function(b){b.classList.contains(c)||
...
(function(d){(function(e){function c(a,b){return a?window.hasOwnProperty.call(a,b):!1}var b={onclick:"onclick",onmouseover:"onmouseover",onchange:"onchange"},a=Object.keys(b);e.hasKey=c;e.makesureElementIdSelector=function(a){if(a)return"#"==a[0]?a:"#"+a;throw"The given node id value is nothing!";};var f=function(){function f(){}f.ensureArguments=function(a){if(isNullOrUndefined(a))return d.Arguments.Default();isNullOrUndefined(a.nativeModel)&&(a.nativeModel=!0);return a};f.select=function(a,b){void 0===
...
g);this.hookEvt(f,b.onmouseover,g);this.hookEvt(f,b.onchange,g)};f.hookEvt=function(a,f,g){if(c(g,f))if(g=g[f],"string"==typeof g)a.setAttribute(f,g);else switch(f){case b.onclick:a.onclick=g;break;case b.onmouseover:a.onmouseover=g;break;case b.onchange:a.onchange=g;break;default:TypeScript.logging.log(f,TypeScript.ConsoleColors.Yellow)}};return f}();e.stringEval=f})(d.Handlers||(d.Handlers={}))})(Internal||(Internal={}));
...
d.numericPattern=/[-]?\d+(\.\d+)?/g;d.integerPattern=/[-]?[0-9]+/g;d.PadLeft=function(a,b,g){void 0===g&&(g=" ");if(d.Empty(a))return DataExtensions.Dim(b,g).join("");b-=a.length;return 0>b?a:DataExtensions.Dim(b,g).join("")+a};d.isNumericPattern=function(a){return c(a,d.numericPattern)};d.isIntegerPattern=function(a){return c(a,d.integerPattern)};d.as_numeric=function(a){return e(a)(a)};d.AsNumeric=e;d.Lanudry=function(a){var b=Math.floor(Math.log(a)/Math.log(1E3));return d.sprintf("%.2f "+["B",
"KB","MB","GB","TB"][b],a/Math.pow(1E3,Math.floor(b)))};d.escapeXml=function(a){return a.replace(/[<>&'"]/g,function(a){switch(a){case "<":return"&lt;";case ">":return"&gt;";case "&":return"&amp;";case "'":return"&apos;";case '"':return"&quot;"}})};d.parseInt=function(a){if(d.Empty(a,!0))return 0;var b=[];for(var g=0;g<a.length;g++){var c=a.charAt(g);var e=c.charCodeAt(0);if(e>=d.x0&&e<=d.x9)b.push(c);else break}return 0==b.length?0:Number(b.join(""))};d.New=function(a,b){if(0==b)return"";if(1==b)return a;
for(var f="",c=1;c<b;++c)f+=a;return f};d.round=function(a,b){void 0===b&&(b=3);var f="number"==typeof a?a:parseFloat(a);b=Math.pow(10,b);return isNaN(f)?(TypeScript.logging.outputWarning&&console.warn("Invalid number value: '"+a+"'"),!1):Math.round(f*b)/b};d.isNumber=function(a){a=a.charCodeAt(0);return a>=d.x0&&a<=d.x9};d.isAlphabet=function(a){a=a.charCodeAt(0);return a>=d.a&&a<=d.z||a>=d.A&&a<=d.Z};d.Val=function(a){return null==a||""==a||void 0==a||"undefined"==a?0:"NA"==a||"NaN"==a?Number.NaN:
"Inf"==a?Number.POSITIVE_INFINITY:"-Inf"==a?Number.NEGATIVE_INFINITY:parseFloat(a)};d.lineTokens=function(a){return a?a.trim().split("\n"):[]};d.GetTagValue=function(a,f){void 0===f&&(f=" ");if(a){var g=f;f=a.indexOf(g);var c=b(g);-1<f?(g=a.substr(0,f),a=a.substr(f+c),a=new NamedValue(g,a)):a=new NamedValue(a,"");return a}return new NamedValue};d.PeekLines=function(a,b){for(var f=0,c=[],e=0;e<b;e++){var d=a.indexOf("\n",f);if(-1<d)c.push(a.substr(f,d-f)),f=d;else break}return c};d.LCase=function(a){return isNullOrUndefined(a)?
"":a.toLowerCase()};d.UCase=function(a){return isNullOrUndefined(a)?"":a.toUpperCase()};d.getAllMatches=function(a,b){var f,c=[];"string"==typeof b&&(b=new RegExp(b));if(b.global)for(;f=b.exec(a);)c.push(f);else(f=b.exec(a))&&c.push(f);return c};d.Trim=function(a,b){void 0===b&&(b=null);if(d.Empty(a,!1))return"";if(isNullOrUndefined(b))return a.trim();"string"==typeof b&&(b=$from(d.ToCharArray(b)).Select(function(a){return a.charCodeAt(0)}).ToArray(!1));return function(b){return $from(d.ToCharArray(a)).SkipWhile(function(a){return-1<
b.indexOf(a.charCodeAt(0))}).Reverse().SkipWhile(function(a){return-1<b.indexOf(a.charCodeAt(0))}).Reverse().JoinBy("")}(b)};d.LTrim=function(a,b){void 0===b&&(b=" ");if(d.Empty(a,!1))return"";"string"==typeof b&&(b=$from(d.ToCharArray(b)).Select(function(a){return a.charCodeAt(0)}).ToArray(!1));return function(b){return $from(d.ToCharArray(a)).SkipWhile(function(a){return-1<b.indexOf(a.charCodeAt(0))}).JoinBy("")}(b)};d.RTrim=function(a,b){void 0===b&&(b=" ");if(d.Empty(a,!1))return"";"string"==
typeof b&&(b=$from(d.ToCharArray(b)).Select(function(a){return a.charCodeAt(0)}).ToArray(!1));for(var f=d.ToCharArray(a),c=0,e=f.length-1;0<e;e--)if(-1==b.indexOf(f[e].charCodeAt(0))){c=e;break}return 0==c?"":a.substr(0,c+1)};d.Empty=function(a,b){void 0===b&&(b=!1);return a?void 0==a||"undefined"==typeof a?!0:0==a.length?!0:!b||"undefined"!=a&&"null"!=a&&"NULL"!=a?!1:!0:!0};d.Blank=function(a,b){void 0===b&&(b=!1);return!a||c(a,/\s+/g)?!0:void 0==a||"undefined"==typeof a?!0:0==a.length?!0:!b||"\\s"!=
a&&"\\t"!=a?!1:!0};d.IsPattern=c;d.Unique=function(a){var b={};return a.filter(function(a){return b.hasOwnProperty(a)?!1:b[a]=!0})};d.Count=function(a,b){for(var f=0,c=0;c<a.length;c++)a[c]==b&&(f+=1);return f};d.ToCharArray=function(a,b){void 0===b&&(b=!1);var f=[],c=a.length;if(b)for(b=0;b<c;++b)f.push(a.charCodeAt(b));else for(b=0;b<c;++b)f.push(a.charAt(b));return f};d.Len=b;d.CompareTo=function(a,b){for(var f=d.Len(a),c=d.Len(b),e=Math.min(f,c),m=0;m<e;m++){var n=a.charCodeAt(m),p=b.charCodeAt(m);
if(n>p)return 1;if(n<p)return-1}return f>c?1:f<c?-1:0};d.sprintf=data.sprintf.doFormat;d.WrappingLines=function(a,b,g){void 0===b&&(b=200);void 0===g&&(g=!1);var f="";a=d.lineTokens(a);for(var c,e=0;e<a.length;e++){var n=g?d.Trim(a[e]):a[e];if(n.length<b)f=f+n+"\n";else for(c=0;;)if(f=f+n.substr(c,b)+"\n",c+=b,c+b>n.length){f=f+n.substr(c)+"\n";break}}return f}})(Strings||(Strings={}));var TypeScript;
...
g,h){return d.md5_cmn(b^(c|~a),e,c,f,g,h)};d.binl_md5=function(e,c){var b=1732584193,a=-271733879,f=-1732584194,g=271733878;e[c>>5]|=128<<c%32;e[(c+64>>>9<<4)+14]=c;for(var h=0;h<e.length;h+=16){c=b;var k=a;var m=f;var n=g;b=d.md5_ff(b,a,f,g,e[h],7,-680876936);g=d.md5_ff(g,b,a,f,e[h+1],12,-389564586);f=d.md5_ff(f,g,b,a,e[h+2],17,606105819);a=d.md5_ff(a,f,g,b,e[h+3],22,-1044525330);b=d.md5_ff(b,a,f,g,e[h+4],7,-176418897);g=d.md5_ff(g,b,a,f,e[h+5],12,1200080426);f=d.md5_ff(f,g,b,a,e[h+6],17,-1473231341);
...
(function(d){(function(e){e.hostNamePattern=/:\/\/(www[0-9]?\.)?(.[^/:]+)/i;e.uriPattern=/data[:]\S+[/]\S+;base64,[a-zA-Z0-9/=+]/ig;e.urlPattern=/((https?)|(ftp))[:]\/{2}\S+\.[a-z]+[^ >"]*/ig;e.isFromSameOrigin=function(c){c=(new d.URL(c)).origin.toLowerCase();var b=window.location.origin.toLowerCase();return c==b};e.isAPossibleUrlPattern=function(c,b){void 0===b&&(b=e.urlPattern);b=c.match(b);if(isNullOrUndefined(b))return!1;b=b[0];return Strings.Empty(b,!0)?!1:0==c.indexOf(b)};e.parseQueryString=
function(c,b){void 0===b&&(b=!1);c=c.split("#")[0].split("&");for(var a={},f=0;f<c.length;f++){var g=c[f].split("="),e=void 0,d=g[0].replace(/\[\d*\]/,function(a){e=a.slice(1,-1);return""});g="undefined"===typeof g[1]?"true":g[1];b&&(d=d.toLowerCase());a[d]?("string"===typeof a[d]&&(a[d]=[a[d]]),"undefined"===typeof e?a[d].push(g):a[d][e]=g):a[d]=g}return a}})(d.URLPatterns||(d.URLPatterns={}))})(TypeScript||(TypeScript={}));
...
(function(d){function e(a,b,g){var f=$ts("<a>");if("download"in f){f.download=a;f.style.display="none";document.body.appendChild(f);if(g&&"string"==typeof b)f.href=b;else try{var c=DataExtensions.uriToBlob(b),e=URL.createObjectURL(c);f.href=e;f.onclick=function(){requestAnimationFrame(function(){URL.revokeObjectURL(e)})}}catch(n){TypeScript.logging.outputWarning&&console.warn("This browser does not support object URLs. Falling back to string URL."),"string"!==typeof b&&(b=DataExtensions.toUri(b)),
f.href=b}f.click();document.body.removeChild(f)}else"string"!==typeof b&&(b=DataExtensions.toUri(b)),window.open(b,"_temp","menubar=no,toolbar=no,status=no")}function c(a,f,g){void 0===f&&(f=null);void 0===g&&(g=null);var c=$ts("<tr>"),e=$ts("<tbody>");var d=Array.isArray(a)?b(f||$ts(Object.keys(a[0]))):b(f||$ts(Object.keys(a.First)));var n=function(a){var b=$ts("<tr>");d.forEach(function(f){return b.appendChild($ts("<td>").display(a[f.key]))});return b};Array.isArray(a)?a.forEach(function(a){return e.appendChild(n(a))}):
a.ForEach(function(a){return e.appendChild(n(a))});d.forEach(function(a){return c.appendChild($ts("<th>",{id:a.value}).display(a.value))});return $ts("<table>",g).asExtends.append($ts("<thead>").display(c)).append(e).HTMLElement}function b(a){var b=$ts.typeof(a);if(b.isArrayOf("string"))return $from(a).Select(function(a){return new MapTuple(a,a)}).ToArray();if(b.isArrayOf(TypeExtensions.DictionaryMap))return a;if(b.isEnumerator&&"string"==typeof a.First)return a.Select(function(a){return new MapTuple(a,
a)}).ToArray();if(b.isEnumerator&&TypeScript.Reflection.getClass(a.First)==TypeExtensions.DictionaryMap)return a.ToArray();throw"Invalid sequence type: "+b.class;}d.inIframe=function(){try{return window.self!==window.top}catch(a){return!0}};d.download=function(a,b,g){void 0===g&&(g=!1);!g&&navigator.msSaveOrOpenBlob?navigator.msSaveOrOpenBlob(DataExtensions.uriToBlob(b),a):e(a,b,g)};d.clientSize=function(){var a=window,b=document,g=b.documentElement;b=b.getElementsByTagName("body")[0];return[a.innerWidth||
g.clientWidth||b.clientWidth,a.innerHeight||g.clientHeight||b.clientHeight]};d.AddSelectOptions=function(a,b,g,c){void 0===g&&(g=null);void 0===c&&(c=null);a=$from(a).Select(function(a){return'<option value="'+a.value+'">'+a.key+"</option>"}).JoinBy("\n");g=isNullOrUndefined(g)&&isNullOrUndefined(c)?a:'\n                <select class="'+c+'" multiple name="'+g+'">\n                    '+a+"\n                </select>";$ts("#"+b).innerHTML=g};d.CreateHTMLTableNode=c;d.AddHTMLTable=function(a,b,g,e){void 0===
g&&(g=null);void 0===e&&(e=null);var f=Strings.Trim(b,"#")+"-table";e?e.id||(e.id=f):e={id:f};$ts(b).appendChild(c(a,g,e))}})(DOM||(DOM={}));
...
function(a){return isNullOrEmpty(a)};a.from=$from;a.csv=function(a,b){"boolean"!=typeof b&&(b=b(a));return csv.dataframe.Parse(a,b)};a.csv.isTsvFile=csv.isTsvFile;a.csv.toObjects=function(a){return csv.dataframe.Parse(a,csv.isTsvFile(a)).Objects()};a.csv.toText=function(a,b){void 0===b&&(b=!1);return csv.toDataFrame(a).buildDoc(b)};a.csv.toUri=function(a,b){a=$ts.csv.toText(a,b);return{mime_type:csv.contentType,data:Base64.encode(a)}};a.evalHTML={table:DOM.CreateHTMLTableNode,selectOptions:DOM.AddSelectOptions};
a.appendTable=DOM.AddHTMLTable;return a}function h(a){var b=d.Handlers.Shared.string();a.select=function(a,b){void 0===b&&(b=window);b=d.Handlers.stringEval.select(a,b);0==b.Count&&TypeScript.logging.warning("select query of '"+a+"' returns no data...");return b};a.select.getSelects=function(a){return b.doEval(a,null,null)};a.select.getSelectedOptions=function(a,b){void 0===b&&(b=window);a=$ts(a,{context:b});a=DOM.InputValueGetter.getSelectedOptions(a);return Array.isArray(a)&&"string"==typeof a[0]?
a:new DOMEnumerator(a)};a.select.getOption=function(a,b){void 0===b&&(b=window);a=$ts(a,{context:b});a=DOM.InputValueGetter.getSelectedOptions(a);return"boolean"==typeof a?a:0==a.length?null:"string"==typeof a[0]?a[0]:a[0].value};return a}function k(a,b,f){var c=TypeScript.Reflection.$typeof(b),g=c.typeOf,e=g in a?a[g]():null;if("object"!=g||"HTMLCollection"!=c.class&&"NodeListOf"!=c.class&&"NodeList"!=c.class){if(c.isArray)return e.doEval(b,c,f);if("function"==c.typeOf)TypeScript.logging.outputEverything&&
!isNullOrUndefined(f)&&"HTMLIFrameElement"==TypeScript.Reflection.getClass(f)&&(console.log("Apply a new ready event on iframe:"),console.log(f)),DOM.Events.ready(b,["interactive","complete"],f);else{if(TypeExtensions.isElement(b))return TypeExtensions.Extends(b);if(isNullOrUndefined(eval)){a=a[c.class];if(isNullOrUndefined(a))throw"Unsupported data type: "+c.toString();return a().doEval(b,c,f)}return e.doEval(b,c,f)}}else return d.Handlers.Shared.HTMLCollection().doEval(b,c,f)}d.StringEval=new d.Handlers.stringEval;
d.typeGenericElement=function(a,b){return"string"==typeof a?d.StringEval.doEval(a,null,b):a};d.Static=function(){var a=d.Handlers.Shared,b=function(b,f){return k(a,b,f)},c=a.string();b.mode=Modes.production;b=f(b,c);b=g(b);b=e(b);return b=h(b)};var m=[":","_"];d.urlSolver=b;d.queryFunction=k})(Internal||(Internal={}));"function"!=typeof String.prototype.startsWith&&(String.prototype.startsWith=function(d){return this.slice(0,d.length)==d});
function $imports(d,e,c,b){void 0===e&&(e=DoNothing);void 0===c&&(c=!1);void 0===b&&(b=!1);return(new HttpHelpers.Imports(d,c,b)).doLoad(e)}function $include(d){"string"==typeof d&&(d=[d]);$ts(function(){return d.forEach(function(e){var c=$ts("<script>",{type:"text/javascript",src:e});c.onload=function(){document.body.removeChild(c)};document.body.appendChild(c)})})}function md5(d,e,c){void 0===e&&(e=null);void 0===c&&(c=null);return MD5.calculate(d,e,c)}
...
function getAllUrlParams(d){void 0===d&&(d=window.location.href);return-1<d.indexOf("?")?(d=Strings.GetTagValue(d,"?").value,d=TypeScript.URLPatterns.parseQueryString(d),new Dictionary(d)):new Dictionary({})}function $goto(d,e){void 0===e&&(e=!1);var c=window;e||(c=window.top);c.location.href=Internal.urlSolver(d,e)}function $download(d,e){void 0===e&&(e=null);DOM.download(e,d,!0)}
function base64_decode(d){d=Strings.lineTokens(d);d=$from(d).Where(function(e){return e&&0<e.length}).Select(function(e){return e.trim()}).JoinBy("");return Base64.decode(d)}function DoNothing(){return null}function saveSvgAsPng(d,e,c){void 0===c&&(c=CanvasHelper.saveSvgAsPng.Options.Default());return CanvasHelper.saveSvgAsPng.Encoder.saveSvgAsPng(d,e,c)}
var sprintf=data.sprintf.doFormat,executeJavaScript="javascript:void(0);",$ts=Internal.Static(),$image=function(d,e){return Internal.typeGenericElement(d,e)},$input=function(d,e){return Internal.typeGenericElement(d,e)},$link=function(d,e){return Internal.typeGenericElement(d,e)},$iframe=function(d,e){return Internal.typeGenericElement(d,e)};function $clone(d){var e={};if(isNullOrUndefined(d))TypeScript.logging.warning("target object is nothing!");else for(var c in d)e[c]=d[c];return e}var TypeExtensions;
...
SlideWindow=function(d){function e(c,b){b=d.call(this,b)||this;b.index=c;return b}__extends(e,d);e.Split=function(c,b,a){void 0===a&&(a=1);Array.isArray(c)||(c=c.ToArray());for(var f=c.length-b,g=[],d=0;d<f;d+=a){for(var k=Array(b),m=0;m<b;m++)k[m]=c[d+m];g.push(new e(d,k))}return new IEnumerator(g)};return e}(IEnumerator),Which;
...
(function(d){(function(e){(function(c){function b(a,b){for(var f=0;f<b.length;f++){var c=b[f],e=a,d=c.name;c=c.value;switch(d.toLowerCase()){case "color":e.style.color=c;break;case "background-color":e.style.backgroundColor=c;break;case "font-size":e.style.fontSize=c;break;default:e.style[d]=c,TypeScript.logging.warning("Set style '"+d+"' is not implements yet...")}}}c.css=function(a,c){b(a,e.parseStylesheet(c))};c.setStyle=b})(e.Setter||(e.Setter={}))})(d.CSS||(d.CSS={}))})(DOM||(DOM={}));
(function(d){(function(e){function c(b,a,f){if(document.addEventListener)if(b&&b.nodeName||b===window)b.addEventListener(a,f,!1);else{if(b&&b.length)for(var e=0;e<b.length;e++)c(b[e],a,f)}else if(b&&b.nodeName||b===window)b.attachEvent("on"+a,function(){return f.call(b,window.event)});else if(b&&b.length)for(e=0;e<b.length;e++)c(b[e],a,f)}e.ready=function(b,a,c){void 0===a&&(a=["interactive","complete"]);void 0===c&&(c=null);var f=isNullOrUndefined(c)?document:isNullOrUndefined(c.contentDocument)?
c.contentWindow.document:c.contentDocument;if("function"===typeof b){if(isNullOrUndefined(f)){if($ts.mode==Modes.production){console.warn("Target document object is nothing! Current event will not be handled....");return}if($ts.mode==Modes.debug){console.warn("Target document object is nothing! Current event will not be handled....");console.log("target iframe:");console.warn(c.contentWindow);return}}else TypeScript.logging.outputEverything&&(TypeScript.logging.log("Add Document.ready event handler.",
TypeScript.ConsoleColors.Green),TypeScript.logging.log("document.readyState = "+f.readyState,TypeScript.ConsoleColors.Green));if(-1<a.indexOf(f.readyState))return b();f.addEventListener("DOMContentLoaded",b,!1)}};e.addEvent=c})(d.Events||(d.Events={}))})(DOM||(DOM={}));
...
c.show=function(){b.show();return c};c.hide=function(){b.hide();return c};c.addClass=function(a){b.addClass(a);return c};c.removeClass=function(a){b.removeClass(a);return c};c.onClassChanged=function(a,b,e){e=new DOM.Events.StatusChanged(function(){return c.classList.contains(a)},e);$ts.hook(e,b)};c.CType=function(){return c};c.clear=function(){c.innerHTML="";return c};c.selects=function(a){return Internal.Handlers.stringEval.select(a,c)};c.attr=function(a,b){if("src"==(a=a.toLowerCase())||"href"==
...
(function(d){(function(e){var c=function(){function b(a){this.meta=a}b.prototype.GetValue=function(a){void 0===a&&(a=null);a||(a=Internal.StackTrace.GetCallerMember().memberName);return a in this.meta?this.meta[a]:null};return b}();e.MetaReader=c})(d.Data||(d.Data={}))})(TypeScript||(TypeScript={}));var TsLinq;
(function(d){var e=function(b){function a(){return b.call(this,[])||this}__extends(a,b);Object.defineProperty(a.prototype,"Q",{get:function(){return this.sequence},enumerable:!0,configurable:!0});a.prototype.enqueue=function(a){var b=this.Last,f=this.Q;a=new c(a);f.push(a);b&&(b.below=a,a.above=b)};a.prototype.extract=function(a){var b=this.Q,c=b[a-1],f=b[a+1];a=b.splice(a,1)[0];c&&(c.below=f);f&&(f.above=c);return a};a.prototype.dequeue=function(){return this.extract(0)};return a}(IEnumerator);d.PriorityQueue=
e;var c=function(){function b(a){this.value=a}b.prototype.toString=function(){return this.value.toString()};return b}();d.QueueItem=c})(TsLinq||(TsLinq={}));var algorithm;
...
(function(d){(function(e){function c(b,c,f,d){if(!b)return e.w3color.emptyObject;c||(c=1);var g=e.rgbToHsl(b.r,b.g,b.b);var h=e.rgbToHwb(b.r,b.g,b.b);var k=e.rgbToCmyk(b.r,b.g,b.b);f=f||g.h;var m=d||g.s;d=a(f);b={red:b.r,green:b.g,blue:b.b,hue:f,sat:m,lightness:g.l,whiteness:h.w,blackness:h.b,cyan:k.c,magenta:k.m,yellow:k.y,black:k.k,ncol:d,opacity:c,valid:!0};b.red=Number(b.red.toFixed(0));b.green=Number(b.green.toFixed(0));b.blue=Number(b.blue.toFixed(0));b.hue=Number(b.hue.toFixed(0));b.sat=Number(b.sat.toFixed(2));
...
parseInt(a[2],10);var l=a[3];if("N"!=l&&"Y"!=l&&"R"!=l&&"B"!=l&&"G"!=l)return!1;a=parseInt(a[4],10)||0;"N"!==l?(d=1.05*d-5.25,"Y"===l&&60>=a?b=1:"Y"===l&&60<a||"R"===l&&80>=a?b=(Math.sqrt(14884-Math.pow("Y"===l?a-60:a+40,2))-22)/100:"R"===l&&80<a||"B"===l?b=0:"G"===l&&(b=(Math.sqrt(33800-Math.pow(a-170,2))-70)/100),"Y"===l&&80>=a?c=0:"Y"===l&&80<a||"R"===l&&60>=a?c=(104-Math.sqrt(11236-Math.pow("Y"===l?a-80+20.5:a+20+20.5,2)))/100:"R"===l&&60<a||"B"===l&&80>=a?c=(Math.sqrt(1E4-Math.pow("R"===l?a-
60-60:a+40-60,2))-10)/100:"B"===l&&80<a||"G"===l&&40>=a?c=(122-Math.sqrt(19881-Math.pow("B"===l?a-80-131:a+20-131,2)))/100:"G"===l&&40<a&&(c=0),"Y"===l?f=(85-.85*a)/100:"R"===l&&60>=a?f=0:"R"===l&&60<a?f=(67.5-Math.sqrt(5776-Math.pow(a-60+35,2)))/100:"B"===l&&60>=a?f=(6.5+Math.sqrt(7044.5-Math.pow(1*a-68.5,2)))/100:"B"===l&&60<a||"G"===l&&60>=a?f=.9:"G"===l&&60<a&&(f=(90-.125*(a-60))/100),l=(b+f+c)/3,b=(l-b)*(100-g)/100+b,f=(l-f)*(100-g)/100+f,c=(l-c)*(100-g)/100+c,l=1/(b>f&&b>c?b:f>b&&f>c?f:c>b&&
c>f?c:(b+f+c)/3),g=parseInt(b*l*(100-d)/100*255,10),f=parseInt(f*l*(100-d)/100*255,10),d=parseInt(c*l*(100-d)/100*255,10),255<g&&(g=255),255<f&&(f=255),255<d&&(d=255),0>g&&(g=0),0>f&&(f=0),0>d&&(d=0)):(d=parseInt(255*(1-d/100),10),255<d&&(d=255),0>d&&(d=0),f=g=d);return{r:g,g:f,b:d}}e.toColorObject=function(a){var d=[],g;a=e.w3trim(a.toLowerCase());var m=a.substr(0,1).toUpperCase();var n=a.substr(1);var p=1;"R"!=m&&"Y"!=m&&"G"!=m&&"C"!=m&&"B"!=m&&"M"!=m&&"W"!=m||isNaN(n)||6==a.length&&-1==a.indexOf(",")||
(a="ncol("+a+")");3==a.length||6==a.length||isNaN(parseFloat(a))||(a="ncol("+a+")");0<a.indexOf(",")&&-1==a.indexOf("(")&&(a="ncol("+a+")");if("rgb"==a.substr(0,3)||"hsl"==a.substr(0,3)||"hwb"==a.substr(0,3)||"ncol"==a.substr(0,4)||"cmyk"==a.substr(0,4)){"ncol"==a.substr(0,4)?(4==a.split(",").length&&-1==a.indexOf("ncola")&&(a=a.replace("ncol","ncola")),m="ncol",a=a.substr(4)):"cmyk"==a.substr(0,4)?(m="cmyk",a=a.substr(4)):(m=a.substr(0,3),a=a.substr(3));n=3;var l=!1;"a"==a.substr(0,1).toLowerCase()?
(n=4,l=!0,a=a.substr(1)):"cmyk"==m&&(n=4,5==a.split(",").length&&(n=5,l=!0));a=a.replace("(","");a=a.replace(")","");d=a.split(",");if("rgb"==m){if(d.length!=n)return e.w3color.emptyObject;for(g=0;g<n;g++){if(""==d[g]||" "==d[g])d[g]="0";-1<d[g].indexOf("%")&&(d[g]=d[g].replace("%",""),d[g]=Number(d[g]/100),3>g&&(d[g]=Math.round(255*d[g])));if(isNaN(d[g]))return e.w3color.emptyObject;255<parseInt(d[g])&&(d[g]=255);3>g&&(d[g]=parseInt(d[g]));3==g&&1<Number(d[g])&&(d[g]=1)}var q={r:d[0],g:d[1],b:d[2]};
1==l&&(p=Number(d[3]))}if("hsl"==m||"hwb"==m||"ncol"==m){for(;d.length<n;)d.push("0");("hsl"==m||"hwb"==m)&&360<=parseInt(d[0])&&(d[0]=0);for(g=1;g<n;g++){if(-1<d[g].indexOf("%")){d[g]=d[g].replace("%","");d[g]=Number(d[g]);if(isNaN(d[g]))return e.w3color.emptyObject;d[g]/=100}else d[g]=Number(d[g]);1<Number(d[g])&&(d[g]=1);0>Number(d[g])&&(d[g]=0)}if("hsl"==m){q=e.hslToRgb(d[0],d[1],d[2]);var v=Number(d[0]);var t=Number(d[1])}"hwb"==m&&(q=e.hwbToRgb(d[0],d[1],d[2]));if("ncol"==m)a:{var r=d[0];a=
d[1];q=d[2];var u=r;if(isNaN(parseFloat(r.substr(0,1)))){g=r.substr(0,1).toUpperCase();r=r.substr(1);""==r&&(r=0);r=Number(r);if(isNaN(r)){q=!1;break a}"R"==g&&(u=.6*r);"Y"==g&&(u=60+.6*r);"G"==g&&(u=120+.6*r);"C"==g&&(u=180+.6*r);"B"==g&&(u=240+.6*r);"M"==g&&(u=300+.6*r);"W"==g&&(u=0,a=1-r/100,q=r/100)}q=e.hwbToRgb(u,a,q)}1==l&&(p=Number(d[3]))}if("cmyk"==m){for(;d.length<n;)d.push("0");for(g=0;g<n;g++){if(-1<d[g].indexOf("%")){d[g]=d[g].replace("%","");d[g]=Number(d[g]);if(isNaN(d[g]))return e.w3color.emptyObject;
d[g]/=100}else d[g]=Number(d[g]);1<Number(d[g])&&(d[g]=1);0>Number(d[g])&&(d[g]=0)}q=e.cmykToRgb(d[0],d[1],d[2],d[3]);1==l&&(p=Number(d[4]))}}else if("ncs"==a.substr(0,3))q=f(a);else{m=!1;n=b("names");for(g=0;g<n.length;g++)if(a.toLowerCase()==n[g].toLowerCase()){n=b("hexs");m=!0;q={r:parseInt(n[g].substr(0,2),16),g:parseInt(n[g].substr(2,2),16),b:parseInt(n[g].substr(4,2),16)};break}if(0==m){a=a.replace("#","");3==a.length&&(a=a.substr(0,1)+a.substr(0,1)+a.substr(1,1)+a.substr(1,1)+a.substr(2,1)+
...
(function(d){function e(b){var a=[],c=0;for(b=b.replace(/[^A-Za-z0-9+/=]/g,"");c<b.length;){var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(c++));var e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(c++));var k="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(c++));var m="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(c++));d=d<<2|e>>4;e=(e&15)<<
4|k>>2;var n=(k&3)<<6|m;a.push(d);64!=k&&a.push(e);64!=m&&a.push(n)}return a}var c=/^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)?$/g;d.isValidBase64String=function(b){return b&&0==b.length%4?c.test(b):!1};d.encode=function(b){var a=[],c=0;for(b=d.utf8_encode(b);c<b.length;){var e=b.charCodeAt(c++);var h=b.charCodeAt(c++);var k=b.charCodeAt(c++);var m=e>>2;e=(e&3)<<4|h>>4;var n=(h&15)<<2|k>>6;var p=k&63;isNaN(h)?n=p=64:isNaN(k)&&(p=64);a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m));
a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e));a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(n));a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(p))}return a.join("")};d.decode=function(b){var a="",c=0;for(b=e(b);c<b.length;c++)a+=String.fromCharCode(b[c]);return a=d.utf8_decode(a)};d.decode_rawBuffer=e;d.bytes_decode=function(b,a){var c=[];b=new Uint8Array(e(b));b=new DataView(b.buffer);for(var d=
0;d<a;d++)c.push(b.getFloat64(8*d));return c};d.utf8_encode=function(b){var a=[];b=b.replace(/rn/g,"n");for(var c=0;c<b.length;c++){var d=b.charCodeAt(c);128>d?a.push(String.fromCharCode(d)):(127<d&&2048>d?a.push(String.fromCharCode(d>>6|192)):(a.push(String.fromCharCode(d>>12|224)),a.push(String.fromCharCode(d>>6&63|128))),a.push(String.fromCharCode(d&63|128)))}return a.join("")};d.utf8_decode=function(b){for(var a=[],c=0,d,e,k;c<b.length;)d=b.charCodeAt(c),128>d?(a.push(String.fromCharCode(d)),
...
(LZW={}));var Levenshtein;
(function(d){function e(b,a,d){void 0===d&&(d=c);b=Strings.ToCharArray(b,!0);a=Strings.ToCharArray(a,!0);if(0==b.length&&0==a.length)return[[0]];if(0==b.length)return[[$ts(a).Sum(function(a){return d.insert(a)})]];if(0==a.length)return[[$ts(b).Sum(function(a){return d.delete(a)})]];var f=b.length+1,e=a.length+1,k=new Matrix(f,e,0);k.column(0,Enumerable.Range(0,f-1));k.row(0,Enumerable.Range(0,e-1));for(var m,n,p,l=1;l<f;l++)for(var q=1;q<e;q++)m=k.M(q-1,l)+d.delete(b[q-1]),n=k.M(q,l-1)+d.insert(a[l-
1]),p=k.M(q-1,l-1)+d.substitute(b[q-1],a[l-1]),k.M(q,l,Enumerable.Min(m,n,p));return k.ToArray(!1)}var c={insert:function(b){return 1},delete:function(b){return 1},substitute:function(b,a){return b==a?0:1}};d.DistanceMatrix=e;d.ComputeDistance=function(b,a,d){void 0===d&&(d=c);b=e(b,a,d);return b[b.length-1][b[0].length-1]}})(Levenshtein||(Levenshtein={}));
...
(function(d){(function(d){function c(a){void 0===a&&(a="id");var b=document.querySelectorAll("*["+a+"]");a=[];var c=0;for(b=$ts(b).ToArray(!1);c<b.length;c++)a.push(b[c].id);return a}function b(b){b=b.toString().replace(a,"");b=b.slice(b.indexOf("(")+1,b.indexOf(")")).match(f);return null===b?[]:b}d.findAllElement=c;d.hookEventHandles=function(a){for(var d=c(),f=TypeScript.Reflection.$typeof(a),e=function(c){if(-1<d.indexOf(c)){var e=b(a[c]);if(0==e.length||2==e.length)$ts("#"+c).onclick=function(b,
d){return a[c](b,d)},console.info("%c["+f.class+"] hook onclick for #"+c+"...","color:green;")}},g=0,p=f.methods;g<p.length;g++){var l=p[g];e(l)}d=c("name");e=function(c){if(-1<d.indexOf(c)){var f=b(a[c]);1==f.length&&"value"==f[0]&&document.getElementsByName(c).forEach(function(b){var d=b.tagName.toLowerCase();"input"==d||"textarea"==d?(d=b.getAttribute("type"),isNullOrUndefined(d)||"file"!=d.toLowerCase()?b.onchange=function(){var d=DOM.InputValueGetter.unifyGetValue(b);return a[c](d)}:b.onchange=
function(){var d=$input(b).files;return a[c](d)}):"select"==d?b.onchange=function(){var d=DOM.InputValueGetter.unifyGetValue(b);return a[c](d)}:TypeScript.logging.log("invalid tag name: "+b.tagName+"!","red")})}};g=0;for(p=f.methods;g<p.length;g++)l=p[g],e(l)};var a=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,f=/([^\s,]+)/g;d.parseFunctionArgumentNames=b})(d.EventHandles||(d.EventHandles={}))})(Internal||(Internal={}));var Framework;
...
$ts("<div>"),f=a.cloneNode(!0);if("svg"==a.tagName){var g=b.width||d.getDimension(a,f,"width");var n=b.height||d.getDimension(a,f,"height")}else if(a.getBBox){var p=a.getBBox();g=p.x+p.width;n=p.y+p.height;f.setAttribute("transform",f.getAttribute("transform").replace(/translate\(.*?\)/,""));p=document.createElementNS("http://www.w3.org/2000/svg","svg");p.appendChild(f);f=p}else{console.error("Attempted to render non-SVG element",a);return}f.setAttribute("version","1.1");f.getAttribute("xmlns")||
f.setAttributeNS(d.xmlns,"xmlns","http://www.w3.org/2000/svg");f.getAttribute("xmlns:xlink")||f.setAttributeNS(d.xmlns,"xmlns:xlink","http://www.w3.org/1999/xlink");b.responsive?(f.removeAttribute("width"),f.removeAttribute("height"),f.setAttribute("preserveAspectRatio","xMinYMin meet")):(f.setAttribute("width",(g*b.scale).toString()),f.setAttribute("height",(n*b.scale).toString()));f.setAttribute("viewBox",[b.left||0,b.top||0,g,n].join(" "));p=f.querySelectorAll("foreignObject > *");for(var l=0;l<
p.length;l++)p[l].getAttribute("xmlns")||p[l].setAttributeNS(d.xmlns,"xmlns","http://www.w3.org/1999/xhtml");e.appendChild(f);d.styles.doStyles(a,b,function(a){a=$ts("<style>",{type:"text/css"}).display("<![CDATA[\n"+a+"\n]]\x3e");a=$ts("<defs>").display(a);f.insertBefore(a,f.firstChild);c&&(a=e.innerHTML,a=a.replace(/NS\d+:href/gi,'xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href'),c(a,g,n))})};b.svgAsDataUri=function(a,b,c){void 0===c&&(c=null);this.prepareSvg(a,b,function(a){a="data:image/svg+xml;base64,"+
window.btoa(d.reEncode(d.doctype+a));c&&c(a)})};b.convertToPng=function(a,b,c,d){b=$ts("<canvas>",{width:b,height:c});c=b.getContext("2d");d.canvg?d.canvg(b,a):c.drawImage(a,0,0);d.backgroundColor&&(c.globalCompositeOperation="destination-over",c.fillStyle=d.backgroundColor,c.fillRect(0,0,b.width,b.height));try{var e=b.toDataURL(d.encoderType,d.encoderOptions)}catch(m){if("SecurityError"==m.name){console.error("Rendered SVG images cannot be downloaded in this browser.");return}throw m;}return e};
...
(function(d){d.CharsParser=function(d,c,b){void 0===c&&(c=",");void 0===b&&(b='"');var a=[],e=[],g=!1,h=$from(Strings.ToCharArray(d)).ToPointer(),k=new RegExp("["+b+"]{2}","g"),m=function(){return e.join("").replace(k,b)};for(d=function(d){var f=e;var k=void 0;void 0===k&&(k="\\");f=isNullOrEmpty(f)?!1:f[f.length-1]==k;f?e[e.length-1]=d:(f=h.Current,k=0<e.length&&e[e.length-1]!=b,0==e.length&&f==c?(a.push(""),e=[],h.MoveNext(),g=!1):(f==c||h.EndRead)&&k?(a.push(m()),e=[],h.MoveNext(),g=!1):e.push(d))};!h.EndRead;){var n=
h.Next;g?n==b?d(n):e.push(n):0==e.length&&n==b?g=!0:n==c?(a.push(m()),e=[]):e.push(n)}0<e.length&&a.push(m());return a}})(csv||(csv={}));
