...
var __spreadArrays=this&&this.__spreadArrays||function(){for(var e=0,d=0,c=arguments.length;d<c;d++)e+=arguments[d].length;e=Array(e);var b=0;for(d=0;d<c;d++)for(var a=arguments[d],f=0,g=a.length;f<g;f++,b++)e[b]=a[f];return e},__extends=this&&this.__extends||function(){var e=function(d,c){e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(b,a){b.__proto__=a}||function(b,a){for(var f in a)a.hasOwnProperty(f)&&(b[f]=a[f])};return e(d,c)};return function(d,c){function b(){this.constructor=
d}e(d,c);d.prototype=null===c?Object.create(c):(b.prototype=c.prototype,new b)}}(),Activator;
...
(function(e){(function(d){var c=function(){function b(){}b.prototype.toString=function(){return JSON.stringify(this)};return b}();d.match=c;d.placeholder=new RegExp(/(%([%]|(\-)?(\+|\x20)?(0)?(\d+)?(\.(\d)?)?([bcdfosxX])))/g);d.parseFormat=function(b,a){for(var f,g,c=f=0,e,n=[],l=[];e=d.placeholder.exec(b);)g=d.placeholder.lastIndex-e[0].length,l[l.length]=b.substring(f,g),f=d.placeholder.lastIndex,n[n.length]={match:e[0],left:e[3]?!0:!1,sign:e[4]||"",pad:e[5]||" ",min:e[6]||0,precision:e[8],code:e[9]||
"%",negative:0>parseInt(a[c])?!0:!1,argument:String(a[c])},e[9]&&(c+=1);l[l.length]=b.substring(f);return{matches:n,convCount:c,strings:l}};d.doFormat=function(b){for(var a=[],f=1;f<arguments.length;f++)a[f-1]=arguments[f];if("undefined"==typeof arguments||1>arguments.length||"string"!=typeof arguments[0]||"undefined"==typeof RegExp)return null;f=d.parseFormat(b,a);var g=f.convCount;if(0==f.matches.length)return b;if(a.length<g)throw"Mismatch format argument numbers ("+a.length+" !== "+g+")!";return d.doSubstitute(f.matches,
f.strings)};d.doSubstitute=function(b,a){var f,g="";for(f=0;f<b.length;f++){if("%"==b[f].code)var c="%";else"b"==b[f].code?(b[f].argument=String(Math.abs(parseInt(b[f].argument)).toString(2)),c=d.convert(b[f],!0)):"c"==b[f].code?(c=Math.abs(parseInt(b[f].argument)),b[f].argument=String(String.fromCharCode(parseInt(String(c)))),c=d.convert(b[f],!0)):"d"==b[f].code?(b[f].argument=String(Math.abs(parseInt(b[f].argument))),c=d.convert(b[f])):"f"==b[f].code?(c=b[f].precision?parseFloat(b[f].precision):
6,b[f].argument=String(Math.abs(parseFloat(b[f].argument)).toFixed(c)),c=d.convert(b[f])):"o"==b[f].code?(b[f].argument=String(Math.abs(parseInt(b[f].argument)).toString(8)),c=d.convert(b[f])):"s"==b[f].code?(c=b[f].precision?parseFloat(b[f].precision):b[f].argument.length,b[f].argument=b[f].argument.substring(0,c),c=d.convert(b[f],!0)):"x"==b[f].code?(b[f].argument=String(Math.abs(parseInt(b[f].argument)).toString(16)),c=d.convert(b[f])):"X"==b[f].code?(b[f].argument=String(Math.abs(parseInt(b[f].argument)).toString(16)),
c=d.convert(b[f]).toUpperCase()):c=b[f].match;g+=a[f];g+=c}return g+a[f]};d.convert=function(b,a){void 0===a&&(a=!1);b.sign=a?"":b.negative?"-":b.sign;var f=parseFloat(b.min)-b.argument.length+1-b.sign.length;f=Array(0>f?0:f).join(b.pad);return b.left?"0"==b.pad||a?b.sign+b.argument+f.replace(/0/g," "):b.sign+b.argument+f:"0"==b.pad||a?b.sign+f+b.argument:f+b.sign+b.argument}})(e.sprintf||(e.sprintf={}))})(data||(data={}));
...
c)};d.prototype.OrderByDescending=function(c){return Enumerable.OrderByDescending(this.sequence,c)};d.prototype.Split=function(c){for(var b=[],a=[],f=0,g=this.sequence;f<g.length;f++){var e=g[f];a.length<c?a.push(e):(b.push(a),a=[])}0<a.length&&b.push(a);return new d(b)};d.prototype.Take=function(c){return Enumerable.Take(this.sequence,c)};d.prototype.Skip=function(c){return Enumerable.Skip(this.sequence,c)};d.prototype.Reverse=function(){var c=this.ToArray().reverse();return new d(c)};d.prototype.TakeWhile=
function(c){return Enumerable.TakeWhile(this.sequence,c)};d.prototype.SkipWhile=function(c){return Enumerable.SkipWhile(this.sequence,c)};d.prototype.All=function(c){return Enumerable.All(this.sequence,c)};d.prototype.Any=function(c){void 0===c&&(c=null);return c?Enumerable.Any(this.sequence,c):this.sequence&&0!=this.sequence.length?!0:!1};d.prototype.Distinct=function(c){void 0===c&&(c=function(b){return b.toString()});return this.GroupBy(c,Strings.CompareTo).Select(function(b){return b.First})};
d.prototype.ChunkWith=function(c,b){void 0===b&&(b=!1);for(var a=new List,f=[],g=0,d=this.sequence;g<d.length;g++){var e=d[g];c(e)?(a.Add(f),f=b?[e]:[]):f.push(e)}0<f.length&&a.Add(f);return a};d.prototype.ForEach=function(c){this.sequence.forEach(c)};d.prototype.JoinBy=function(c,b){void 0===b&&(b=function(a){return"string"===typeof a?a:a.toString()});return this.Select(function(a){return b(a)}).ToArray().join(c)};d.prototype.Unlist=function(c){void 0===c&&(c=function(a){return a});for(var b=[],
a=0,f=this.sequence;a<f.length;a++)for(var g=0,e=c(f[a]);g<e.length;g++)b.push(e[g]);return new d(b)};d.prototype.ToArray=function(c){void 0===c&&(c=!0);return c?__spreadArrays(this.sequence):this.sequence};d.prototype.ToList=function(){return new List(this.sequence)};d.prototype.ToDictionary=function(c,b){void 0===b&&(b=function(a){return a});for(var a={},f,g,d=0,e=this.sequence;d<e.length;d++)g=e[d],f=c(g),g=b(g),a[f]=g;return new Dictionary(a)};d.prototype.ToPointer=function(){return new Pointer(this)};
d.prototype.SlideWindows=function(c,b){void 0===b&&(b=1);return SlideWindow.Split(this,c,b)};return d}(LINQIterator),DOMEnumerator=function(e){function d(c){return e.call(this,d.ensureElements(c))||this}__extends(d,e);Object.defineProperty(d.prototype,"tagName",{get:function(){return this.First.tagName},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"type",{get:function(){return"input"==this.tagName.toLowerCase()?this.First.type:this.tagName},enumerable:!0,configurable:!0});d.ensureElements=
function(c){var b=$ts.typeof(c);if("NodeList"==b.class){var a=[];c.forEach(function(b){return a.push(b)})}else if("HTMLCollection"==b.class)for(a=[],b=0;b<c.length;b++)a.push(c.item(b));else a=Framework.Extensions.EnsureArray(c);c=0;for(b=a;c<b.length;c++)TypeExtensions.Extends(b[c]);return a};d.prototype.val=function(c){void 0===c&&(c=null);if(isNullOrUndefined(c))return this.Select(function(b){return d.getVal(b)});"string"==typeof c||"number"==typeof c?this.ForEach(function(b){return d.setVal(b,
c)}):Array.isArray(c)?this.ForEach(function(b,a){return d.setVal(b,c[a])}):this.ForEach(function(b,a){return d.setVal(b,c.ElementAt(a))})};d.setVal=function(c,b){c instanceof HTMLInputElement?c.value=b:c.textContent=b};d.getVal=function(c){return c instanceof HTMLInputElement?c.value:c.textContent};d.prototype.attr=function(c,b){void 0===b&&(b=null);if(b){if("function"==typeof b)return this.Select(function(a){var f=b(a);a.setAttribute(c,f);return f});var a=Framework.Extensions.EnsureArray(b,this.Count);
return this.Select(function(b,g){g=a[g];b.setAttribute(c,g);return g})}return this.Select(function(a){return a.getAttribute(c)})};d.prototype.addClass=function(c){this.ForEach(function(b){b.classList.contains(c)||b.classList.add(c)});return this};d.prototype.addEvent=function(c,b){this.ForEach(function(a){DOM.Events.addEvent(a,c,function(f){b(a,f)})})};d.prototype.onChange=function(c){this.addEvent("onchange",c)};d.prototype.onClick=function(c){this.ForEach(function(b){b.onclick=function(a){c(this,
a);return!1}})};d.prototype.removeClass=function(c){this.ForEach(function(b){b.classList.contains(c)&&b.classList.remove(c)});return this};d.prototype.hide=function(){this.ForEach(function(c){return c.style.display="none"});return this};d.prototype.show=function(){this.ForEach(function(c){return c.style.display="block"});return this};d.prototype.delete=function(){this.ForEach(function(c){return c.parentNode.removeChild(c)})};return d}(IEnumerator),Internal;
...
e.numericPattern=/[-]?\d+(\.\d+)?/g;e.isNumericPattern=function(a){return c(a,e.numericPattern)};e.as_numeric=function(a){return d(a)(a)};e.AsNumeric=d;e.Lanudry=function(a){var b=Math.floor(Math.log(a)/Math.log(1E3));return e.sprintf("%.2f "+["B","KB","MB","GB","TB"][b],a/Math.pow(1E3,Math.floor(b)))};e.escapeXml=function(a){return a.replace(/[<>&'"]/g,function(a){switch(a){case "<":return"&lt;";case ">":return"&gt;";case "&":return"&amp;";case "'":return"&apos;";case '"':return"&quot;"}})};e.parseInt=
function(a){if(e.Empty(a,!0))return 0;var b=[];for(var g=0;g<a.length;g++){var c=a.charAt(g);var d=c.charCodeAt(0);if(d>=e.x0&&d<=e.x9)b.push(c);else break}return 0==b.length?0:Number(b.join(""))};e.New=function(a,b){if(0==b)return"";if(1==b)return a;for(var f="",c=1;c<b;++c)f+=a;return f};e.round=function(a,b){void 0===b&&(b=3);var f="number"==typeof a?a:parseFloat(a);b=Math.pow(10,b);return isNaN(f)?(TypeScript.logging.outputWarning&&console.warn("Invalid number value: '"+a+"'"),!1):Math.round(f*
b)/b};e.isNumber=function(a){a=a.charCodeAt(0);return a>=e.x0&&a<=e.x9};e.isAlphabet=function(a){a=a.charCodeAt(0);return a>=e.a&&a<=e.z||a>=e.A&&a<=e.Z};e.Val=function(a){return null==a||""==a||void 0==a||"undefined"==a?0:"NA"==a||"NaN"==a?Number.NaN:"Inf"==a?Number.POSITIVE_INFINITY:"-Inf"==a?Number.NEGATIVE_INFINITY:parseFloat(a)};e.lineTokens=function(a){return a?a.trim().split("\n"):[]};e.GetTagValue=function(a,f){void 0===f&&(f=" ");if(a){var g=f;f=a.indexOf(g);var c=b(g);-1<f?(g=a.substr(0,
f),a=a.substr(f+c),a=new NamedValue(g,a)):a=new NamedValue(a,"");return a}return new NamedValue};e.PeekLines=function(a,b){for(var f=0,c=[],d=0;d<b;d++){var e=a.indexOf("\n",f);if(-1<e)c.push(a.substr(f,e-f)),f=e;else break}return c};e.LCase=function(a){return isNullOrUndefined(a)?"":a.toLowerCase()};e.UCase=function(a){return isNullOrUndefined(a)?"":a.toUpperCase()};e.getAllMatches=function(a,b){var f,c=[];"string"==typeof b&&(b=new RegExp(b));if(b.global)for(;f=b.exec(a);)c.push(f);else(f=b.exec(a))&&
c.push(f);return c};e.Trim=function(a,b){void 0===b&&(b=null);if(e.Empty(a,!1))return"";if(isNullOrUndefined(b))return a.trim();"string"==typeof b&&(b=$from(e.ToCharArray(b)).Select(function(a){return a.charCodeAt(0)}).ToArray(!1));return function(b){return $from(e.ToCharArray(a)).SkipWhile(function(a){return-1<b.indexOf(a.charCodeAt(0))}).Reverse().SkipWhile(function(a){return-1<b.indexOf(a.charCodeAt(0))}).Reverse().JoinBy("")}(b)};e.LTrim=function(a,b){void 0===b&&(b=" ");if(e.Empty(a,!1))return"";
"string"==typeof b&&(b=$from(e.ToCharArray(b)).Select(function(a){return a.charCodeAt(0)}).ToArray(!1));return function(b){return $from(e.ToCharArray(a)).SkipWhile(function(a){return-1<b.indexOf(a.charCodeAt(0))}).JoinBy("")}(b)};e.RTrim=function(a,b){void 0===b&&(b=" ");if(e.Empty(a,!1))return"";"string"==typeof b&&(b=$from(e.ToCharArray(b)).Select(function(a){return a.charCodeAt(0)}).ToArray(!1));for(var f=e.ToCharArray(a),c=0,d=f.length-1;0<d;d--)if(-1==b.indexOf(f[d].charCodeAt(0))){c=d;break}return 0==
c?"":a.substr(0,c+1)};e.Empty=function(a,b){void 0===b&&(b=!1);return a?void 0==a||"undefined"==typeof a?!0:0==a.length?!0:!b||"undefined"!=a&&"null"!=a&&"NULL"!=a?!1:!0:!0};e.Blank=function(a,b){void 0===b&&(b=!1);return!a||c(a,/\s+/g)?!0:void 0==a||"undefined"==typeof a?!0:0==a.length?!0:!b||"\\s"!=a&&"\\t"!=a?!1:!0};e.IsPattern=c;e.Unique=function(a){var b={};return a.filter(function(a){return b.hasOwnProperty(a)?!1:b[a]=!0})};e.Count=function(a,b){for(var f=0,c=0;c<a.length;c++)a[c]==b&&(f+=1);
return f};e.ToCharArray=function(a,b){void 0===b&&(b=!1);var g=[],f=a.length;if(b)for(b=0;b<f;++b)g.push(a.charCodeAt(b));else for(b=0;b<f;++b)g.push(a.charAt(b));return g};e.Len=b;e.CompareTo=function(a,b){for(var g=e.Len(a),f=e.Len(b),c=Math.min(g,f),d=0;d<c;d++){var l=a.charCodeAt(d),p=b.charCodeAt(d);if(l>p)return 1;if(l<p)return-1}return g>f?1:g<f?-1:0};e.sprintf=data.sprintf.doFormat;e.WrappingLines=function(a,b,g){void 0===b&&(b=200);void 0===g&&(g=!1);var f="";a=e.lineTokens(a);for(var c,
d=0;d<a.length;d++){var l=g?e.Trim(a[d]):a[d];if(l.length<b)f=f+l+"\n";else for(c=0;;)if(f=f+l.substr(c,b)+"\n",c+=b,c+b>l.length){f=f+l.substr(c)+"\n";break}}return f}})(Strings||(Strings={}));var TypeScript;
(function(e){(function(d){var c=function(){function b(){}Object.defineProperty(b.prototype,"isPrimitive",{get:function(){return!this.class},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"isArray",{get:function(){return"array"==this.typeOf},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"isEnumerator",{get:function(){return"object"==this.typeOf&&("IEnumerator"==this.class||"DOMEnumerator"==this.class)},enumerable:!0,configurable:!0});b.prototype.isArrayOf=function(a){return this.isArray&&
this.class==a};b.prototype.toString=function(){return"object"==this.typeOf?"<"+this.typeOf+"> "+this.class:this.typeOf};return b}();d.TypeInfo=c})(e.Reflection||(e.Reflection={}))})(TypeScript||(TypeScript={}));var MD5;
...
g,h){return e.md5_cmn(b^(c|~a),d,c,f,g,h)};e.binl_md5=function(d,c){var b=1732584193,a=-271733879,f=-1732584194,g=271733878;d[c>>5]|=128<<c%32;d[(c+64>>>9<<4)+14]=c;for(var h=0;h<d.length;h+=16){c=b;var k=a;var n=f;var l=g;b=e.md5_ff(b,a,f,g,d[h],7,-680876936);g=e.md5_ff(g,b,a,f,d[h+1],12,-389564586);f=e.md5_ff(f,g,b,a,d[h+2],17,606105819);a=e.md5_ff(a,f,g,b,d[h+3],22,-1044525330);b=e.md5_ff(b,a,f,g,d[h+4],7,-176418897);g=e.md5_ff(g,b,a,f,d[h+5],12,1200080426);f=e.md5_ff(f,g,b,a,d[h+6],17,-1473231341);
...
(function(e){(function(d){d.hostNamePattern=/:\/\/(www[0-9]?\.)?(.[^/:]+)/i;d.uriPattern=/data[:]\S+[/]\S+;base64,[a-zA-Z0-9/=+]/ig;d.urlPattern=/((https?)|(ftp))[:]\/{2}\S+\.[a-z]+[^ >"]*/ig;d.isFromSameOrigin=function(c){c=(new e.URL(c)).origin.toLowerCase();var b=window.location.origin.toLowerCase();return c==b};d.isAPossibleUrlPattern=function(c,b){void 0===b&&(b=d.urlPattern);b=c.match(b);if(isNullOrUndefined(b))return!1;b=b[0];return Strings.Empty(b,!0)?!1:0==c.indexOf(b)};d.parseQueryString=
function(c,b){void 0===b&&(b=!1);c=c.split("#")[0].split("&");for(var a={},f=0;f<c.length;f++){var g=c[f].split("="),d=void 0,e=g[0].replace(/\[\d*\]/,function(a){d=a.slice(1,-1);return""});g="undefined"===typeof g[1]?"true":g[1];b&&(e=e.toLowerCase());a[e]?("string"===typeof a[e]&&(a[e]=[a[e]]),"undefined"===typeof d?a[e].push(g):a[e][d]=g):a[e]=g}return a}})(e.URLPatterns||(e.URLPatterns={}))})(TypeScript||(TypeScript={}));
...
(function(e){(function(d){function c(a){var b=[],f;for(f in a)"function"==typeof a[f]&&b.push(f);return b}function b(b,c,d,e){return c?f(b):d?a(b,e):""}function a(a,b){return b?(e.logging.log(TypeExtensions.objectIsNothing),"null"):a.constructor.name}function f(a){a=a[0];var b;"object"==(b=typeof a)&&(b=a.constructor.name);return b}d.$typeof=function(a){var f=typeof a,g="object"==f,e=Array.isArray(a),l=isNullOrUndefined(a),p=new d.TypeInfo,m=b(a,e,g,l);p.typeOf=e?"array":f;p.class=m;l?(p.property=
...
(function(e){function d(a,b,g){var f=$ts("<a>");if("download"in f){f.download=a;f.style.display="none";document.body.appendChild(f);if(g&&"string"==typeof b)f.href=b;else try{var c=DataExtensions.uriToBlob(b),d=URL.createObjectURL(c);f.href=d;f.onclick=function(){requestAnimationFrame(function(){URL.revokeObjectURL(d)})}}catch(l){TypeScript.logging.outputWarning&&console.warn("This browser does not support object URLs. Falling back to string URL."),"string"!==typeof b&&(b=DataExtensions.toUri(b)),
f.href=b}f.click();document.body.removeChild(f)}else"string"!==typeof b&&(b=DataExtensions.toUri(b)),window.open(b,"_temp","menubar=no,toolbar=no,status=no")}function c(a,f,g){void 0===f&&(f=null);void 0===g&&(g=null);var c=$ts("<thead>"),d=$ts("<tbody>");var e=Array.isArray(a)?b(f||$ts(Object.keys(a[0]))):b(f||$ts(Object.keys(a.First)));var l=function(a){var b=$ts("<tr>");e.forEach(function(f){return b.appendChild($ts("<td>").display(a[f.key]))});return b};Array.isArray(a)?a.forEach(function(a){return d.appendChild(l(a))}):
a.ForEach(function(a){return d.appendChild(l(a))});e.forEach(function(a){return c.appendChild($ts("<th>",{id:a.value}).display(a.value))});return $ts("<table>",g).asExtends.append(c).append(d).HTMLElement}function b(a){var b=$ts.typeof(a);if(b.isArrayOf("string"))return $from(a).Select(function(a){return new MapTuple(a,a)}).ToArray();if(b.isArrayOf(TypeExtensions.DictionaryMap))return a;if(b.isEnumerator&&"string"==typeof a.First)return a.Select(function(a){return new MapTuple(a,a)}).ToArray();if(b.isEnumerator&&
TypeScript.Reflection.getClass(a.First)==TypeExtensions.DictionaryMap)return a.ToArray();throw"Invalid sequence type: "+b.class;}e.inIframe=function(){try{return window.self!==window.top}catch(a){return!0}};e.download=function(a,b,g){void 0===g&&(g=!1);!g&&navigator.msSaveOrOpenBlob?navigator.msSaveOrOpenBlob(DataExtensions.uriToBlob(b),a):d(a,b,g)};e.clientSize=function(){var a=window,b=document,g=b.documentElement;b=b.getElementsByTagName("body")[0];return[a.innerWidth||g.clientWidth||b.clientWidth,
a.innerHeight||g.clientHeight||b.clientHeight]};e.AddSelectOptions=function(a,b,g,c){void 0===g&&(g=null);void 0===c&&(c=null);a=$from(a).Select(function(a){return'<option value="'+a.value+'">'+a.key+"</option>"}).JoinBy("\n");g=isNullOrUndefined(g)&&isNullOrUndefined(c)?a:'\n                <select class="'+c+'" multiple name="'+g+'">\n                    '+a+"\n                </select>";$ts("#"+b).innerHTML=g};e.CreateHTMLTableNode=c;e.AddHTMLTable=function(a,b,g,d){void 0===g&&(g=null);void 0===
d&&(d=null);var f=Strings.Trim(b,"#")+"-table";d?d.id||(d.id=f):d={id:f};$ts(b).appendChild(c(a,g,d))}})(DOM||(DOM={}));
...
{}));
(function(e){(function(d){function c(a){var f=a.type.toLowerCase();return"checkbox"==f?b(a,!0):"radio"==f?a instanceof DOMEnumerator?a.Where(function(a){return a.checked}).FirstOrDefault().value:a.value:a.value}function b(a,b){void 0===b&&(b=!1);a=a instanceof DOMEnumerator?a:new DOMEnumerator(document.getElementsByName(a.name));return 1==a.Count?(a=a.ElementAt(0),b?a.checked:a.checked?a.value:null):a.Where(function(a){return a.checked}).Select(function(a){return a.value}).ToArray(!1)}function a(a){var b=[],
c=0;for(a=f(a);c<a.length;c++){var g=a[c],d=g.value;d||(d=g.innerText);b.push(d)}return b}function f(a){var b=[];if(a instanceof HTMLSelectElement)for(var f=0,c=a.options.length;f<c;f++){var g=a.options[f];g.selected&&b.push(g)}else return a instanceof HTMLInputElement?a.checked?a.value:!1:a.Where(function(a){return a.checked}).Select(function(a){return a.value}).ToArray(!1);return b}d.metaValue=function(a,b,f){void 0===b&&(b=null);void 0===f&&(f=!1);a='meta[name~="'+a+'"]';var c=document.querySelector(a);
!c&&f&&(c=parent.window.document.querySelector(a));c?b=(f=c.getAttribute("content"))?f:b:TypeScript.logging.outputWarning&&console.warn(a+" not found in current context!");return b};d.getValue=function(b,f){void 0===f&&(f=!0);b=$ts(b);switch(b.tagName.toLowerCase()){case "input":return c(b);case "select":return a(b);case "textarea":return b.value;default:if(f)throw"Get value of <"+b.tagName+"> is not supported!";return b.getAttribute("value")}};d.inputValue=c;d.checkboxInput=b;d.selectOptionValues=
a;d.getSelectedOptions=f;d.largeText=function(a){return a.value}})(e.InputValueGetter||(e.InputValueGetter={}))})(DOM||(DOM={}));
(function(e){(function(d){function c(){for(var b=0,c=a;b<c.length;b++){var d=c[b];d.hasUpdate()&&d.invoke()}}var b=!1,a=[];d.Add=function(f,g,e){void 0===e&&(e=null);if(f instanceof d.StatusChanged){var h=f;f=function(){return h.changed}}a.push({hasUpdate:f,invoke:g,name:e});b||(setInterval(c,10),b=!0,TypeScript.logging.outputEverything&&console.log("Start background worker..."))}})(e.Events||(e.Events={}))})(DOM||(DOM={}));
...
a.text=function(a,f){void 0===f&&(f=!1);a=e.Handlers.makesureElementIdSelector(a);a=b.doEval(a,null,null);f=f?a.innerHTML:a.innerText;TypeScript.logging.log(f,TypeScript.ConsoleColors.DarkGreen);return f};a.loadJSON=function(b){return JSON.parse(a.text(b))};var f={"\u2714":!0,T:!0,"true":!0,True:!0,TRUE:!0,yes:!0,success:!0,pass:!0},c={"\u2718":!1,F:!1,"false":!1,FALSE:!1,False:!1,wrong:!1,failure:!1};a.parseFileName=TypeScript.PathHelper.fileName;a.parseBool=function(a){return isNullOrUndefined(a)?
!1:"number"==typeof a?0!==a:a in f?!0:a in c?!1:!0};a.unixtimestamp=function(){return Math.round((new Date).getTime())};a.baseName=TypeScript.PathHelper.basename;a.extensionName=TypeScript.PathHelper.extensionName;a.withExtensionName=function(a,b){return $ts.extensionName(a).toLowerCase()==b.toLowerCase()};a.doubleRange=data.NumericRange.Create;a.hook=DOM.Events.Add;a.typeof=TypeScript.Reflection.$typeof;a.clone=function(a){return DataExtensions.merge(a,{})};return a}function g(a){a.isNullOrEmpty=
function(a){return isNullOrEmpty(a)};a.from=$from;a.csv=function(a,b){"boolean"!=typeof b&&(b=b(a));return csv.dataframe.Parse(a,b)};a.csv.toObjects=function(a){return csv.dataframe.Parse(a,csv.isTsvFile(a)).Objects()};a.csv.toText=function(a,b){void 0===b&&(b=!1);return csv.toDataFrame(a).buildDoc(b)};a.csv.toUri=function(a,b){a=$ts.csv.toText(a,b);return{mime_type:csv.contentType,data:Base64.encode(a)}};a.evalHTML={table:DOM.CreateHTMLTableNode,selectOptions:DOM.AddSelectOptions};a.appendTable=
DOM.AddHTMLTable;return a}function h(a){var b=e.Handlers.Shared.string();a.select=function(a,b){void 0===b&&(b=window);return e.Handlers.stringEval.select(a,b)};a.select.getSelects=function(a){return b.doEval(a,null,null)};a.select.getSelectedOptions=function(a,b){void 0===b&&(b=window);a=$ts(a,{context:b});a=DOM.InputValueGetter.getSelectedOptions(a);return new DOMEnumerator(a)};a.select.getOption=function(a,b){void 0===b&&(b=window);a=$ts(a,{context:b});a=DOM.InputValueGetter.getSelectedOptions(a);
return"boolean"==typeof a?a:0==a.length?null:"string"==typeof a[0]?a[0]:a[0].value};return a}function k(a,b,f){var c=TypeScript.Reflection.$typeof(b),g=c.typeOf,d=g in a?a[g]():null;if("object"!=g||"HTMLCollection"!=c.class&&"NodeListOf"!=c.class){if(c.isArray)return d.doEval(b,c,f);if("function"==c.typeOf)TypeScript.logging.outputEverything&&!isNullOrUndefined(f)&&"HTMLIFrameElement"==TypeScript.Reflection.getClass(f)&&(console.log("Apply a new ready event on iframe:"),console.log(f)),DOM.Events.ready(b,
["interactive","complete"],f);else{if(TypeExtensions.isElement(b))return TypeExtensions.Extends(b);if(isNullOrUndefined(eval)){a=a[c.class];if(isNullOrUndefined(a))throw"Unsupported data type: "+c.toString();return a().doEval(b,c,f)}return d.doEval(b,c,f)}}else return e.Handlers.Shared.HTMLCollection().doEval(b,c,f)}e.StringEval=new e.Handlers.stringEval;e.Static=function(){var a=e.Handlers.Shared,b=function(b,f){return k(a,b,f)},c=a.string();b.mode=Modes.production;b=f(b,c);b=g(b);b=d(b);return b=
h(b)};var n=[":","_"];e.urlSolver=b;e.queryFunction=k})(Internal||(Internal={}));"function"!=typeof String.prototype.startsWith&&(String.prototype.startsWith=function(e){return this.slice(0,e.length)==e});function $imports(e,d,c,b){void 0===d&&(d=DoNothing);void 0===c&&(c=!1);void 0===b&&(b=!1);return(new HttpHelpers.Imports(e,c,b)).doLoad(d)}
...
function $goto(e,d){void 0===d&&(d=!1);var c=window;d||(c=window.top);c.location.href=Internal.urlSolver(e,d)}function $download(e,d){void 0===d&&(d=null);DOM.download(d,e,!0)}function base64_decode(e){e=Strings.lineTokens(e);e=$from(e).Where(function(d){return d&&0<d.length}).Select(function(d){return d.trim()}).JoinBy("");return Base64.decode(e)}function DoNothing(){return null}
function saveSvgAsPng(e,d,c){void 0===c&&(c=CanvasHelper.saveSvgAsPng.Options.Default());return CanvasHelper.saveSvgAsPng.Encoder.saveSvgAsPng(e,d,c)}var sprintf=data.sprintf.doFormat,executeJavaScript="javascript:void(0);",$ts=Internal.Static();function $image(e,d){return Internal.StringEval.doEval(e,null,d)}function $input(e,d){return Internal.StringEval.doEval(e,null,d)}function $link(e,d){return Internal.StringEval.doEval(e,null,d)}var TypeExtensions;
...
SlideWindow=function(e){function d(c,b){b=e.call(this,b)||this;b.index=c;return b}__extends(d,e);d.Split=function(c,b,a){void 0===a&&(a=1);Array.isArray(c)||(c=c.ToArray());for(var f=c.length-b,g=[],e=0;e<f;e+=a){for(var k=Array(b),n=0;n<b;n++)k[n]=c[e+n];g.push(new d(e,k))}return new IEnumerator(g)};return d}(IEnumerator),Which;
(function(e){function d(b,a){void 0===a&&(a=c.default());for(var f=null,g=0,d=0;d<b.Count;d++)0<a(b.ElementAt(d),f)&&(f=b.ElementAt(d),g=d);return g}e.Is=function(b){Array.isArray(b)&&(b=new IEnumerator(b));return b.Select(function(a,b){return{flag:a,index:b}}).Where(function(a){return a.flag}).Select(function(a){return a.index})};var c=function(){function b(){this.as_numeric=null}b.prototype.compares=function(a,b){this.as_numeric||(this.as_numeric=Strings.AsNumeric(a),this.as_numeric||(this.as_numeric=
...
(function(e){(function(d){(function(c){function b(a,b){a=a.style;TypeScript.logging.log(b);for(var c=0;c<b.length;c++){var f=b[c],d=a,e=f.name;f=f.value;switch(e.toLowerCase()){case "color":d.color=f;break;case "background-color":d.backgroundColor=f;break;case "font-size":d.fontSize=f;break;default:d[e]=f,TypeScript.logging.warning("Set style '"+e+"' is not implements yet...")}}}c.css=function(a,c){b(a,d.parseStylesheet(c))};c.setStyle=b})(d.Setter||(d.Setter={}))})(e.CSS||(e.CSS={}))})(DOM||(DOM=
{}));
(function(e){(function(d){function c(b,a,f){if(document.addEventListener)if(b&&b.nodeName||b===window)b.addEventListener(a,f,!1);else{if(b&&b.length)for(var d=0;d<b.length;d++)c(b[d],a,f)}else if(b&&b.nodeName||b===window)b.attachEvent("on"+a,function(){return f.call(b,window.event)});else if(b&&b.length)for(d=0;d<b.length;d++)c(b[d],a,f)}d.ready=function(b,a,c){void 0===a&&(a=["interactive","complete"]);void 0===c&&(c=null);var f=isNullOrUndefined(c)?document:isNullOrUndefined(c.contentDocument)?c.contentWindow.document:
c.contentDocument;if("function"===typeof b){if(isNullOrUndefined(f)){if($ts.mode==Modes.production){console.warn("Target document object is nothing! Current event will not be handled....");return}if($ts.mode==Modes.debug){console.warn("Target document object is nothing! Current event will not be handled....");console.log("target iframe:");console.warn(c.contentWindow);return}}else TypeScript.logging.outputEverything&&(console.log("Add Document.ready event handler."),console.log("document.readyState = "+
f.readyState));if(-1<a.indexOf(f.readyState))return b();f.addEventListener("DOMContentLoaded",b,!1)}};d.addEvent=c})(e.Events||(e.Events={}))})(DOM||(DOM={}));
...
(function(e){function d(c,b){"string"==typeof b?b=$ts("<span>").display(b):"function"==typeof b&&(b=b());c.append(b)}e.Extends=function(c){if(isNullOrUndefined(c))return null;var b=new HTMLTsElement(c);c.css=function(a,b){void 0===b&&(b=!1);b?c.setAttribute("style",a):DOM.CSS.Setter.css(c,a);return c};c.display=function(a){b.display(a);return c};c.append=function(a){if(Array.isArray(a))a.forEach(function(a){return d(b,a)});else for(var f=0;f<arguments.length;f++)d(b,arguments[f]);return c};c.show=
function(){b.show();return c};c.hide=function(){b.hide();return c};c.addClass=function(a){b.addClass(a);return c};c.removeClass=function(a){b.removeClass(a);return c};c.onClassChanged=function(a,b,d){d=new DOM.Events.StatusChanged(function(){return c.classList.contains(a)},d);$ts.hook(d,b)};c.CType=function(){return c};c.clear=function(){c.innerHTML="";return c};c.selects=function(a){return Internal.Handlers.stringEval.select(a,c)};c.attr=function(a,b){if("src"==(a=a.toLowerCase())||"href"==a)b=Internal.urlSolver(b,
!0),TypeScript.logging.log("set_attr "+a+"='"+b+"'");isNullOrUndefined(b)?c.removeAttribute(a):c.setAttribute(a,b);return c};c.interactive=function(a){a?(c.style.pointerEvents="auto",c.style.opacity="1"):(c.style.pointerEvents="none",c.style.opacity="0.4")};c.asExtends=b;c.any=c;c.asImage=c;return c.asInput=c}})(TypeExtensions||(TypeExtensions={}));
(function(e){(function(d){var c=function(){function b(a){this.meta=a}b.prototype.GetValue=function(a){void 0===a&&(a=null);a||(a=Internal.StackTrace.GetCallerMember().memberName);return a in this.meta?this.meta[a]:null};return b}();d.MetaReader=c})(e.Data||(e.Data={}))})(TypeScript||(TypeScript={}));var TsLinq;
(function(e){var d=function(b){function a(){return b.call(this,[])||this}__extends(a,b);Object.defineProperty(a.prototype,"Q",{get:function(){return this.sequence},enumerable:!0,configurable:!0});a.prototype.enqueue=function(a){var b=this.Last,f=this.Q;a=new c(a);f.push(a);b&&(b.below=a,a.above=b)};a.prototype.extract=function(a){var b=this.Q,c=b[a-1],f=b[a+1];a=b.splice(a,1)[0];c&&(c.below=f);f&&(f.above=c);return a};a.prototype.dequeue=function(){return this.extract(0)};return a}(IEnumerator);e.PriorityQueue=
d;var c=function(){function b(a){this.value=a}b.prototype.toString=function(){return this.value.toString()};return b}();e.QueueItem=c})(TsLinq||(TsLinq={}));var algorithm;
...
(function(e){(function(d){function c(b,c,f,e){if(!b)return d.w3color.emptyObject;c||(c=1);var g=d.rgbToHsl(b.r,b.g,b.b);var h=d.rgbToHwb(b.r,b.g,b.b);var k=d.rgbToCmyk(b.r,b.g,b.b);f=f||g.h;var n=e||g.s;e=a(f);b={red:b.r,green:b.g,blue:b.b,hue:f,sat:n,lightness:g.l,whiteness:h.w,blackness:h.b,cyan:k.c,magenta:k.m,yellow:k.y,black:k.k,ncol:e,opacity:c,valid:!0};b.red=Number(b.red.toFixed(0));b.green=Number(b.green.toFixed(0));b.blue=Number(b.blue.toFixed(0));b.hue=Number(b.hue.toFixed(0));b.sat=Number(b.sat.toFixed(2));
...
parseInt(a[2],10);var m=a[3];if("N"!=m&&"Y"!=m&&"R"!=m&&"B"!=m&&"G"!=m)return!1;a=parseInt(a[4],10)||0;"N"!==m?(e=1.05*e-5.25,"Y"===m&&60>=a?b=1:"Y"===m&&60<a||"R"===m&&80>=a?b=(Math.sqrt(14884-Math.pow("Y"===m?a-60:a+40,2))-22)/100:"R"===m&&80<a||"B"===m?b=0:"G"===m&&(b=(Math.sqrt(33800-Math.pow(a-170,2))-70)/100),"Y"===m&&80>=a?c=0:"Y"===m&&80<a||"R"===m&&60>=a?c=(104-Math.sqrt(11236-Math.pow("Y"===m?a-80+20.5:a+20+20.5,2)))/100:"R"===m&&60<a||"B"===m&&80>=a?c=(Math.sqrt(1E4-Math.pow("R"===m?a-
60-60:a+40-60,2))-10)/100:"B"===m&&80<a||"G"===m&&40>=a?c=(122-Math.sqrt(19881-Math.pow("B"===m?a-80-131:a+20-131,2)))/100:"G"===m&&40<a&&(c=0),"Y"===m?f=(85-.85*a)/100:"R"===m&&60>=a?f=0:"R"===m&&60<a?f=(67.5-Math.sqrt(5776-Math.pow(a-60+35,2)))/100:"B"===m&&60>=a?f=(6.5+Math.sqrt(7044.5-Math.pow(1*a-68.5,2)))/100:"B"===m&&60<a||"G"===m&&60>=a?f=.9:"G"===m&&60<a&&(f=(90-.125*(a-60))/100),m=(b+f+c)/3,b=(m-b)*(100-g)/100+b,f=(m-f)*(100-g)/100+f,c=(m-c)*(100-g)/100+c,m=1/(b>f&&b>c?b:f>b&&f>c?f:c>b&&
c>f?c:(b+f+c)/3),g=parseInt(b*m*(100-e)/100*255,10),f=parseInt(f*m*(100-e)/100*255,10),e=parseInt(c*m*(100-e)/100*255,10),255<g&&(g=255),255<f&&(f=255),255<e&&(e=255),0>g&&(g=0),0>f&&(f=0),0>e&&(e=0)):(e=parseInt(255*(1-e/100),10),255<e&&(e=255),0>e&&(e=0),f=g=e);return{r:g,g:f,b:e}}d.toColorObject=function(a){var e=[],g;a=d.w3trim(a.toLowerCase());var n=a.substr(0,1).toUpperCase();var l=a.substr(1);var p=1;"R"!=n&&"Y"!=n&&"G"!=n&&"C"!=n&&"B"!=n&&"M"!=n&&"W"!=n||isNaN(l)||6==a.length&&-1==a.indexOf(",")||
(a="ncol("+a+")");3==a.length||6==a.length||isNaN(parseFloat(a))||(a="ncol("+a+")");0<a.indexOf(",")&&-1==a.indexOf("(")&&(a="ncol("+a+")");if("rgb"==a.substr(0,3)||"hsl"==a.substr(0,3)||"hwb"==a.substr(0,3)||"ncol"==a.substr(0,4)||"cmyk"==a.substr(0,4)){"ncol"==a.substr(0,4)?(4==a.split(",").length&&-1==a.indexOf("ncola")&&(a=a.replace("ncol","ncola")),n="ncol",a=a.substr(4)):"cmyk"==a.substr(0,4)?(n="cmyk",a=a.substr(4)):(n=a.substr(0,3),a=a.substr(3));l=3;var m=!1;"a"==a.substr(0,1).toLowerCase()?
(l=4,m=!0,a=a.substr(1)):"cmyk"==n&&(l=4,5==a.split(",").length&&(l=5,m=!0));a=a.replace("(","");a=a.replace(")","");e=a.split(",");if("rgb"==n){if(e.length!=l)return d.w3color.emptyObject;for(g=0;g<l;g++){if(""==e[g]||" "==e[g])e[g]="0";-1<e[g].indexOf("%")&&(e[g]=e[g].replace("%",""),e[g]=Number(e[g]/100),3>g&&(e[g]=Math.round(255*e[g])));if(isNaN(e[g]))return d.w3color.emptyObject;255<parseInt(e[g])&&(e[g]=255);3>g&&(e[g]=parseInt(e[g]));3==g&&1<Number(e[g])&&(e[g]=1)}var q={r:e[0],g:e[1],b:e[2]};
1==m&&(p=Number(e[3]))}if("hsl"==n||"hwb"==n||"ncol"==n){for(;e.length<l;)e.push("0");("hsl"==n||"hwb"==n)&&360<=parseInt(e[0])&&(e[0]=0);for(g=1;g<l;g++){if(-1<e[g].indexOf("%")){e[g]=e[g].replace("%","");e[g]=Number(e[g]);if(isNaN(e[g]))return d.w3color.emptyObject;e[g]/=100}else e[g]=Number(e[g]);1<Number(e[g])&&(e[g]=1);0>Number(e[g])&&(e[g]=0)}if("hsl"==n){q=d.hslToRgb(e[0],e[1],e[2]);var v=Number(e[0]);var t=Number(e[1])}"hwb"==n&&(q=d.hwbToRgb(e[0],e[1],e[2]));if("ncol"==n)a:{var r=e[0];a=
e[1];q=e[2];var u=r;if(isNaN(parseFloat(r.substr(0,1)))){g=r.substr(0,1).toUpperCase();r=r.substr(1);""==r&&(r=0);r=Number(r);if(isNaN(r)){q=!1;break a}"R"==g&&(u=.6*r);"Y"==g&&(u=60+.6*r);"G"==g&&(u=120+.6*r);"C"==g&&(u=180+.6*r);"B"==g&&(u=240+.6*r);"M"==g&&(u=300+.6*r);"W"==g&&(u=0,a=1-r/100,q=r/100)}q=d.hwbToRgb(u,a,q)}1==m&&(p=Number(e[3]))}if("cmyk"==n){for(;e.length<l;)e.push("0");for(g=0;g<l;g++){if(-1<e[g].indexOf("%")){e[g]=e[g].replace("%","");e[g]=Number(e[g]);if(isNaN(e[g]))return d.w3color.emptyObject;
e[g]/=100}else e[g]=Number(e[g]);1<Number(e[g])&&(e[g]=1);0>Number(e[g])&&(e[g]=0)}q=d.cmykToRgb(e[0],e[1],e[2],e[3]);1==m&&(p=Number(e[4]))}}else if("ncs"==a.substr(0,3))q=f(a);else{n=!1;l=b("names");for(g=0;g<l.length;g++)if(a.toLowerCase()==l[g].toLowerCase()){l=b("hexs");n=!0;q={r:parseInt(l[g].substr(0,2),16),g:parseInt(l[g].substr(2,2),16),b:parseInt(l[g].substr(4,2),16)};break}if(0==n){a=a.replace("#","");3==a.length&&(a=a.substr(0,1)+a.substr(0,1)+a.substr(1,1)+a.substr(1,1)+a.substr(2,1)+
...
(function(e){var d=/^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)?$/g;e.isValidBase64String=function(c){return c&&0==c.length%4?d.test(c):!1};e.encode=function(c){var b=[],a=0;for(c=e.utf8_encode(c);a<c.length;){var f=c.charCodeAt(a++);var d=c.charCodeAt(a++);var h=c.charCodeAt(a++);var k=f>>2;f=(f&3)<<4|d>>4;var n=(d&15)<<2|h>>6;var l=h&63;isNaN(d)?n=l=64:isNaN(h)&&(l=64);b.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k));b.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f));
b.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(n));b.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l))}return b.join("")};e.decode=function(c){var b="",a=0;for(c=c.replace(/[^A-Za-z0-9+/=]/g,"");a<c.length;){var f="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(c.charAt(a++));var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(c.charAt(a++));var h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(c.charAt(a++));
var k="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(c.charAt(a++));f=f<<2|d>>4;d=(d&15)<<4|h>>2;var n=(h&3)<<6|k;b+=String.fromCharCode(f);64!=h&&(b+=String.fromCharCode(d));64!=k&&(b+=String.fromCharCode(n))}return b=e.utf8_decode(b)};e.utf8_encode=function(c){var b=[];c=c.replace(/rn/g,"n");for(var a=0;a<c.length;a++){var f=c.charCodeAt(a);128>f?b.push(String.fromCharCode(f)):(127<f&&2048>f?b.push(String.fromCharCode(f>>6|192)):(b.push(String.fromCharCode(f>>12|224)),
b.push(String.fromCharCode(f>>6&63|128))),b.push(String.fromCharCode(f&63|128)))}return b.join("")};e.utf8_decode=function(c){for(var b=[],a=0,f,d,e;a<c.length;)f=c.charCodeAt(a),128>f?(b.push(String.fromCharCode(f)),a++):191<f&&224>f?(d=c.charCodeAt(a+1),b.push(String.fromCharCode((f&31)<<6|d&63)),a+=2):(d=c.charCodeAt(a+1),e=c.charCodeAt(a+2),b.push(String.fromCharCode((f&15)<<12|(d&63)<<6|e&63)),a+=3);return b.join("")}})(Base64||(Base64={}));var LZW;
...
(LZW={}));var Levenshtein;
(function(e){function d(b,a,f){void 0===f&&(f=c);b=Strings.ToCharArray(b,!0);a=Strings.ToCharArray(a,!0);if(0==b.length&&0==a.length)return[[0]];if(0==b.length)return[[$ts(a).Sum(function(a){return f.insert(a)})]];if(0==a.length)return[[$ts(b).Sum(function(a){return f.delete(a)})]];var d=b.length+1,e=a.length+1,k=new Matrix(d,e,0);k.column(0,Enumerable.Range(0,d-1));k.row(0,Enumerable.Range(0,e-1));for(var n,l,p,m=1;m<d;m++)for(var q=1;q<e;q++)n=k.M(q-1,m)+f.delete(b[q-1]),l=k.M(q,m-1)+f.insert(a[m-
1]),p=k.M(q-1,m-1)+f.substitute(b[q-1],a[m-1]),k.M(q,m,Enumerable.Min(n,l,p));return k.ToArray(!1)}var c={insert:function(b){return 1},delete:function(b){return 1},substitute:function(b,a){return b==a?0:1}};e.DistanceMatrix=d;e.ComputeDistance=function(b,a,f){void 0===f&&(f=c);b=d(b,a,f);return b[b.length-1][b[0].length-1]}})(Levenshtein||(Levenshtein={}));
...
(function(e){var d=function(){function c(){}Object.defineProperty(c,"hasWorkerFeature",{get:function(){return"undefined"!==typeof Worker?!0:!1},enumerable:!0,configurable:!0});c.RunWorker=function(b,a,f){void 0===f&&(f=null);TypeScript.URLPatterns.isAPossibleUrlPattern(b)?this.fetchWorker(b,f,function(f){return c.registerWorker(b,f,a)}):this.registerWorker(md5(b),this.buildWorker(b,f),a)};c.registerWorker=function(b,a,f){c.$workers[b]=new Worker(a);c.$workers[b].onmessage=f};c.buildWorker=function(b,
a){if(!isNullOrUndefined(a)){var c;for(c in a){var d=a[c];var e="{$"+c+"}";b=b.replace(e,d)}}try{var k=new Blob([b],{type:"application/javascript"})}catch(n){a=window,a.BlobBuilder=a.BlobBuilder||a.WebKitBlobBuilder||a.MozBlobBuilder,k=a.BlobBuilder(),k.append(b),k=k.getBlob()}return URL.createObjectURL(k)};c.fetchWorker=function(b,a,c){var f=this;$ts.getText(b,function(b){b=f.buildWorker(b,a);TypeScript.logging.log("Build worker blob url: "+b,TypeScript.ConsoleColors.Gray);c(b)})};c.Stop=function(b){c.$workers[b].terminate();
delete c.$workers[b]};c.$workers={};return c}();e.BackgroundWorker=d})(Internal||(Internal={}));var Router;
(function(e){function d(a,b){b(f[a])}function c(a,b){void 0===b&&(b="/");var c=$ts.typeof(a);return{module:b,appName:a.appName,className:c.class,status:a.appStatus,hookUnload:a.appHookMsg}}function b(b){var c=TypeScript.URL.WindowLocation().hash;if(c=a.Item(c))"/"==c?(window.location.hash="",window.location.reload(!0)):$ts("#"+b).innerHTML=HttpHelpers.GET(c)}var a,f,g=!0;e.appName=DOM.InputValueGetter.metaValue("app");e.isCaseSensitive=function(){return g};e.CaseInsensitive=function(a){void 0===a&&
(a=!0);g=!a};e.AddAppHandler=function(a,b){void 0===b&&(b="/");isNullOrUndefined(f)&&(f={});b in f||(f[b]=new Dictionary({}));d(b,function(b){return b.Add(a.appName,a)})};var h={"/":"general","index.php":"php server","index.perl":"perl server","index.do":"","index.jsp":"java server","index.vbs":"VB server script","index.vb":"VB server","index.asp":"VB6 server","index.aspx":"VB.NET server"};e.getAppSummary=c;e.RunApp=function(a){void 0===a&&(a="/");TypeScript.logging.log(TypeScript.URL.WindowLocation());
if(a in f)d(a,function(a){return a.Select(function(a){return a.value.Init()})});else if("index"==a||a in h){a=!1;for(var b=0,e=Object.keys(h);b<e.length;b++){var g=e[b];if(g in f){d(g,function(a){return a.Select(function(a){return a.value.Init()})});a=!0;break}}if(!a)throw"Default module is not found!";}else throw'Module "'+a+'" is not exists in your web app.';if(TypeScript.logging.outputEverything){var k=[];Object.keys(f).forEach(function(a){d(a,function(b){b.ForEach(function(b){return k.push(c(b.value,
a))})})});console.table(k)}};e.queryKey=function(a){return function(b){return getAllUrlParams(b).Item(a)}};e.moduleName=function(){return function(a){return(new TypeScript.URL(a)).fileName}};e.register=function(c,f,d){void 0===c&&(c="app");void 0===f&&(f=null);void 0===d&&(d=!0);a||(a=new Dictionary({"/":"/"}));var g=f?"string"==typeof f?e.queryKey(f):f:function(a){return(new TypeScript.URL(a)).fileName};f=$ts(".router");f.attr("router-link",function(a){return a.href});f.attr("href","javascript:void(0);");
f.onClick(function(a,b){e.goto(a.getAttribute("router-link"),c,g)});f.attr("router-link").ForEach(function(b){a.Add(g(b),b)});b(c)};e.IsTopWindowStack=function(){return parent&&parent.location.pathname==window.location.pathname};e.goto=function(a,b,c,f){e.IsTopWindowStack()?($ts("#"+b).innerHTML=HttpHelpers.GET(a),e.register(b,c,!1),window.location.hash=c(a)):parent.Router.goto(a,b,c,parent)}})(Router||(Router={}));
...
function(){var d=this,c=this;this.isCurrentApp()&&($ts(function(){return d.OnDocumentReady()}),window.onload=c.OnWindowLoad,window.onbeforeunload=c.OnWindowUnload,window.onhashchange=function(){var b=window.location.hash.substr(1);c.OnHashChanged(b)},this.init(),this.status="Running")};e.prototype.OnDocumentReady=function(){};e.prototype.OnWindowLoad=function(){};e.prototype.OnWindowUnload=function(){if(!Strings.Empty(this.hookUnload,!0))return this.hookUnload};e.prototype.unhook=function(){this.hookUnload=
null};e.prototype.OnHashChanged=function(d){};e.prototype.toString=function(){return"["+this.status+"] "+this.appName};return e}(),Framework;
(function(e){(function(d){function c(a,b){void 0===b&&(b=-1);var c=$ts.typeof(a);if(c.isEnumerator)c=a.ToArray();else if(c.isArray)c=__spreadArrays(a);else if(0>=b)c=[a];else{c=[];for(var f=0;f<b;f++)c.push(a)}if(1<=b)if(b<c.length)c=c.slice(0,b);else if(b>c.length)for(f=c.length;f<b;f++)c.push(null);return c}function b(a,c){void 0===c&&(c=null);if(null==a||"object"!=typeof a||a.constructor!=Object&&a.constructor!=Array)return a;if(a.constructor==Date||a.constructor==RegExp||a.constructor==Function||
a.constructor==String||a.constructor==Number||a.constructor==Boolean)return new a.constructor(a);c=c||new a.constructor;for(var f in a)c[f]="undefined"==typeof c[f]?b(a[f],null):c[f];return c}d.EnsureCollection=function(a,b){void 0===b&&(b=-1);return new IEnumerator(c(a,b))};d.EnsureArray=c;d.extend=b})(e.Extensions||(e.Extensions={}))})(Framework||(Framework={}));(function(e){e.gc=function(){return e.garbageCollect.handler()}})(TypeScript||(TypeScript={}));
...
(function(e){var d=function(){function c(){}c.prototype.toString=function(){return this.caller+" [as "+this.memberName+"]("+this.file+":"+this.line+":"+this.column+")"};c.Parse=function(b){var a=new c,f=c.getFileName(b);b=b.replace(f,"").trim().substr(3);f=f.substr(1,f.length-2);if(-1<b.indexOf("/")||-1<b.indexOf(":"))b="<HTML\\Document>";var d=$ts(f.match(/([:]\d+){2}$/m)[0].split(":")),e=d.Select(function(a){return a.length}).Sum()+2;d=$from(d).Where(function(a){return 0<a.length}).Select(function(a){return Strings.Val(a)}).ToArray();
a.file=f.substr(0,f.length-e);(f=(f=b.match(/\[.+\]/))&&0!=f.length?f[0]:null)?(b=b.substr(0,b.length-f.length).trim(),a.memberName=f.substr(3,f.length-4).trim()):(f=b.split("."),a.memberName=f[f.length-1]);a.caller=b;a.line=d[0];a.column=d[1];return a};c.getFileName=function(b){var a=b.match(/\(.+\)/);return a&&0!=a.length?a[0]:"("+b.substr(6).trim()+")"};return c}();e.StackFrame=d})(Internal||(Internal={}));
...
$ts("<div>"),f=a.cloneNode(!0);if("svg"==a.tagName){var g=b.width||d.getDimension(a,f,"width");var l=b.height||d.getDimension(a,f,"height")}else if(a.getBBox){var p=a.getBBox();g=p.x+p.width;l=p.y+p.height;f.setAttribute("transform",f.getAttribute("transform").replace(/translate\(.*?\)/,""));p=document.createElementNS("http://www.w3.org/2000/svg","svg");p.appendChild(f);f=p}else{console.error("Attempted to render non-SVG element",a);return}f.setAttribute("version","1.1");f.getAttribute("xmlns")||
f.setAttributeNS(d.xmlns,"xmlns","http://www.w3.org/2000/svg");f.getAttribute("xmlns:xlink")||f.setAttributeNS(d.xmlns,"xmlns:xlink","http://www.w3.org/1999/xlink");b.responsive?(f.removeAttribute("width"),f.removeAttribute("height"),f.setAttribute("preserveAspectRatio","xMinYMin meet")):(f.setAttribute("width",(g*b.scale).toString()),f.setAttribute("height",(l*b.scale).toString()));f.setAttribute("viewBox",[b.left||0,b.top||0,g,l].join(" "));p=f.querySelectorAll("foreignObject > *");for(var m=0;m<
p.length;m++)p[m].getAttribute("xmlns")||p[m].setAttributeNS(d.xmlns,"xmlns","http://www.w3.org/1999/xhtml");e.appendChild(f);d.styles.doStyles(a,b,function(a){a=$ts("<style>",{type:"text/css"}).display("<![CDATA[\n"+a+"\n]]\x3e");a=$ts("<defs>").display(a);f.insertBefore(a,f.firstChild);c&&(a=e.innerHTML,a=a.replace(/NS\d+:href/gi,'xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href'),c(a,g,l))})};b.svgAsDataUri=function(a,b,c){void 0===c&&(c=null);this.prepareSvg(a,b,function(a){a="data:image/svg+xml;base64,"+
window.btoa(d.reEncode(d.doctype+a));c&&c(a)})};b.convertToPng=function(a,b,c,d){b=$ts("<canvas>",{width:b,height:c});c=b.getContext("2d");d.canvg?d.canvg(b,a):c.drawImage(a,0,0);d.backgroundColor&&(c.globalCompositeOperation="destination-over",c.fillStyle=d.backgroundColor,c.fillRect(0,0,b.width,b.height));try{var e=b.toDataURL(d.encoderType,d.encoderOptions)}catch(n){if("SecurityError"==n.name){console.error("Rendered SVG images cannot be downloaded in this browser.");return}throw n;}return e};
...
var d=function(){function c(){this.sendContentType=!0}c.prototype.toString=function(){return this.type};return c}();e.PostData=d})(HttpHelpers||(HttpHelpers={}));var csv;
...
(function(e){var d=function(c){function b(a){return c.call(this,a)||this}__extends(b,c);Object.defineProperty(b.prototype,"columns",{get:function(){return __spreadArrays(this.sequence)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"rowLine",{get:function(){return $from(this.columns).Select(b.autoEscape).JoinBy(",")},enumerable:!0,configurable:!0});b.prototype.indexOf=function(a,b){void 0===b&&(b=null);return isNullOrUndefined(b)?this.sequence.indexOf(a):this.sequence.indexOf(a,
...
(function(e){e.CharsParser=function(d,c,b){void 0===c&&(c=",");void 0===b&&(b='"');var a=[],e=[],g=!1,h=$from(Strings.ToCharArray(d)).ToPointer(),k=new RegExp("["+b+"]{2}","g"),n=function(){return e.join("").replace(k,b)};for(d=function(d){var f=e;var k=void 0;void 0===k&&(k="\\");f=isNullOrEmpty(f)?!1:f[f.length-1]==k;f?e[e.length-1]=d:(f=h.Current,k=0<e.length&&e[e.length-1]!=b,0==e.length&&f==c?(a.push(""),e=[],h.MoveNext(),g=!1):(f==c||h.EndRead)&&k?(a.push(n()),e=[],h.MoveNext(),g=!1):e.push(d))};!h.EndRead;){var l=
h.Next;g?l==b?d(l):e.push(l):0==e.length&&l==b?g=!0:l==c?(a.push(n()),e=[]):e.push(l)}0<e.length&&a.push(n());return a}})(csv||(csv={}));
